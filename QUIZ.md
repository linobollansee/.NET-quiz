...
| 5001 | What is performance optimization? | Improving software speed and resource usage | It enhances user experience. |
| 5002 | What is application performance monitoring? | Monitoring application behavior and performance | It detects bottlenecks. |
| 5003 | What is profiling? | Analyzing application execution characteristics | It finds performance issues. |
| 5004 | What is CPU profiling? | Measuring CPU usage by code sections | It identifies expensive operations. |
| 5005 | What is memory profiling? | Analyzing memory allocation and usage | It finds memory problems. |
| 5006 | What is memory leak? | Memory that is allocated but not released | It increases resource usage. |
| 5007 | What is garbage collection? | Automatic memory management in .NET | It removes unused objects. |
| 5008 | What is GC generation? | A grouping strategy used by .NET garbage collector | It optimizes collection. |
| 5009 | What is Generation 0? | The youngest garbage collection generation | It contains short-lived objects. |
| 5010 | What is Generation 1? | Intermediate garbage collection generation | It stores longer-lived objects. |
| 5011 | What is Generation 2? | Oldest garbage collection generation | It stores long-lived objects. |
| 5012 | What is Large Object Heap? | Memory area for large allocations | It stores large objects. |
| 5013 | What is LOH compaction? | Rearranging large object heap memory | It reduces fragmentation. |
| 5014 | What is stack memory? | Memory storing local variables and call frames | It is automatically managed. |
| 5015 | What is heap memory? | Memory storing dynamically allocated objects | Garbage collection manages it. |
| 5016 | What is boxing allocation? | Creating an object wrapper for a value type | It can impact performance. |
| 5017 | What is allocation pressure? | Frequent object creation causing GC activity | It affects performance. |
| 5018 | What is object pooling? | Reusing objects instead of creating new ones | It reduces allocations. |
| 5019 | What is ArrayPool<T>? | .NET pool for reusable arrays | It improves memory efficiency. |
| 5020 | What is ObjectPool<T>? | A reusable object management mechanism | It reduces creation overhead. |
| 5021 | What is Span<T>? | A stack-only view over contiguous memory | It enables high-performance operations. |
| 5022 | What is ReadOnlySpan<T>? | A read-only memory view | It avoids unnecessary allocations. |
| 5023 | What is Memory<T>? | A heap-friendly memory representation | It supports asynchronous scenarios. |
| 5024 | What is stackalloc? | C# keyword allocating memory on the stack | It improves performance for temporary data. |
| 5025 | What is unsafe code? | C# code allowing direct memory operations | It provides low-level access. |
| 5026 | What is pointer? | A variable storing a memory address | It is used in unsafe code. |
| 5027 | What is interop? | Communication between managed and unmanaged code | It enables native integration. |
| 5028 | What is P/Invoke? | Calling native functions from .NET | It enables OS API access. |
| 5029 | What is COM interop? | Interaction between .NET and COM components | It supports legacy integration. |
| 5030 | What is unmanaged code? | Code executed outside the .NET runtime | It manages memory manually. |
| 5031 | What is managed code? | Code executed under the .NET runtime | CLR manages execution. |
| 5032 | What is CLR? | Common Language Runtime | It executes .NET applications. |
| 5033 | What is CTS? | Common Type System | It defines .NET data types. |
| 5034 | What is CLS? | Common Language Specification | It defines language interoperability rules. |
| 5035 | What is IL? | Intermediate Language generated by .NET compilers | CLR executes it. |
| 5036 | What is JIT compiler? | Just-In-Time compiler converting IL to machine code | It runs code efficiently. |
| 5037 | What is AOT compilation? | Ahead-Of-Time compilation producing native code | It improves startup performance. |
| 5038 | What is ReadyToRun? | Precompiled .NET assembly format | It reduces startup time. |
| 5039 | What is Native AOT? | .NET compilation directly to native executable | It reduces runtime dependency. |
| 5040 | What is assembly? | A compiled .NET unit containing code and metadata | It is deployed as DLL or EXE. |
| 5041 | What is DLL? | Dynamic Link Library | It contains reusable compiled code. |
| 5042 | What is EXE assembly? | Executable .NET assembly | It starts an application. |
| 5043 | What is metadata? | Information describing assemblies and types | CLR uses it for execution. |
| 5044 | What is reflection? | Inspecting assemblies and types at runtime | It enables dynamic behavior. |
| 5045 | What is attribute? | Metadata attached to code elements | It provides additional information. |
| 5046 | What is custom attribute? | User-defined metadata class | It extends compiler/runtime information. |
| 5047 | What is assembly loading? | Process of loading assemblies into runtime | It enables execution. |
| 5048 | What is AssemblyLoadContext? | .NET mechanism controlling assembly loading | It supports isolation. |
| 5049 | What is plugin architecture? | Design allowing external modules to be loaded | It enables extensibility. |
| 5050 | What is dynamic loading? | Loading code at runtime | It supports flexible systems. |
| 5051 | What is .NET runtime? | The execution environment for .NET applications | It manages code execution and services. |
| 5052 | What is .NET SDK? | A toolkit for building .NET applications | It includes compilers and CLI tools. |
| 5053 | What is .NET CLI? | Command-line interface for .NET development | It creates, builds, and runs projects. |
| 5054 | What is dotnet build? | A CLI command compiling a .NET project | It produces build outputs. |
| 5055 | What is dotnet run? | A CLI command running a .NET application | It builds and starts the app. |
| 5056 | What is dotnet test? | A CLI command executing tests | It runs test projects. |
| 5057 | What is dotnet publish? | A CLI command preparing deployment files | It creates deployable output. |
| 5058 | What is dotnet restore? | A CLI command restoring dependencies | It downloads required packages. |
| 5059 | What is dotnet clean? | A CLI command removing build outputs | It resets generated files. |
| 5060 | What is dotnet watch? | A CLI tool monitoring file changes | It supports rapid development. |
| 5061 | What is SDK-style project? | Modern .NET project format | It simplifies project files. |
| 5062 | What is csproj file? | C# project configuration file | It defines build settings. |
| 5063 | What is solution file? | A container grouping multiple projects | It organizes development work. |
| 5064 | What is project reference? | A dependency reference between projects | It enables code sharing. |
| 5065 | What is target framework? | The platform version a project targets | It defines available APIs. |
| 5066 | What is TFM? | Target Framework Moniker | It identifies target frameworks. |
| 5067 | What is .NET Standard? | A specification of shared .NET APIs | It enables library compatibility. |
| 5068 | What is .NET Framework? | The original Windows-focused .NET platform | It supports legacy applications. |
| 5069 | What is .NET Core? | A cross-platform .NET implementation | It evolved into modern .NET. |
| 5070 | What is modern .NET? | Unified cross-platform .NET platform | It supports cloud and desktop apps. |
| 5071 | What is runtime identifier? | Identifier for a target operating system and architecture | It controls deployment output. |
| 5072 | What is RID? | Runtime Identifier abbreviation | It identifies deployment platforms. |
| 5073 | What is self-contained deployment? | Deployment including the .NET runtime | It runs without installed runtime. |
| 5074 | What is framework-dependent deployment? | Deployment requiring installed .NET runtime | It produces smaller output. |
| 5075 | What is single-file deployment? | Publishing an app as one executable | It simplifies distribution. |
| 5076 | What is trimming? | Removing unused code during publishing | It reduces application size. |
| 5077 | What is globalization? | Supporting different cultures and languages | It enables international applications. |
| 5078 | What is localization? | Adapting software for a specific culture | It changes resources and formats. |
| 5079 | What is culture in .NET? | Information about language and regional settings | It controls formatting. |
| 5080 | What is CultureInfo? | .NET class representing culture information | It manages localization data. |
| 5081 | What is resource file? | A file storing localized content | It supports multiple languages. |
| 5082 | What is .resx file? | XML-based .NET resource file | It stores localized resources. |
| 5083 | What is satellite assembly? | Assembly containing localized resources | It supports language-specific deployment. |
| 5084 | What is DateTime? | A .NET type representing date and time | It stores temporal values. |
| 5085 | What is DateTimeOffset? | A date and time with offset information | It handles time zones better. |
| 5086 | What is TimeZoneInfo? | .NET class managing time zones | It converts between zones. |
| 5087 | What is UTC? | Coordinated Universal Time | It provides a global time reference. |
| 5088 | What is ISO 8601? | International date and time format standard | It avoids ambiguity. |
| 5089 | What is formatting? | Converting values into readable text | It controls display. |
| 5090 | What is parsing? | Converting text into typed values | It interprets input. |
| 5091 | What is TryParse()? | A method safely converting strings to values | It avoids exceptions. |
| 5092 | What is IFormatProvider? | Interface providing formatting information | It supports culture-aware operations. |
| 5093 | What is string interpolation? | Embedding expressions inside strings | It improves readability. |
| 5094 | What is composite formatting? | Formatting strings using placeholders | It uses format arguments. |
| 5095 | What is StringBuilder? | A mutable string construction class | It avoids repeated allocations. |
| 5096 | What is immutable string? | A string that cannot be modified after creation | It improves safety. |
| 5097 | What is string interning? | Reusing identical string instances | It saves memory. |
| 5098 | What is regular expression? | A pattern language for text matching | It processes complex text patterns. |
| 5099 | What is Regex class? | .NET class for regular expressions | It performs pattern matching. |
| 5100 | What is globalization invariant mode? | .NET mode without culture-specific data | It reduces application size. |
| 5101 | What is LINQ? | Language Integrated Query for querying data | It provides consistent query syntax. |
| 5102 | What is LINQ to Objects? | LINQ querying in-memory collections | It uses IEnumerable. |
| 5103 | What is LINQ to SQL? | LINQ querying relational databases | It maps queries to SQL. |
| 5104 | What is LINQ provider? | A component translating LINQ queries for a data source | It enables different query targets. |
| 5105 | What is deferred execution? | Delaying query execution until results are requested | It improves flexibility. |
| 5106 | What is immediate execution? | Executing a query immediately | Methods like ToList() trigger it. |
| 5107 | What is IQueryable? | An interface representing provider-based queries | It supports query translation. |
| 5108 | What is IEnumerable? | An interface for iterating collections | It executes queries in memory. |
| 5109 | What is IEnumerator? | An object controlling collection iteration | It supports foreach. |
| 5110 | What is yield return? | A C# feature creating iterators lazily | It simplifies enumeration. |
| 5111 | What is lambda expression? | An anonymous function expression | It is common in LINQ. |
| 5112 | What is expression tree? | A representation of code as data | LINQ providers translate it. |
| 5113 | What is Func delegate? | A delegate returning a value | It represents functions. |
| 5114 | What is Action delegate? | A delegate returning void | It represents operations. |
| 5115 | What is Predicate delegate? | A delegate returning a boolean | It tests conditions. |
| 5116 | What is Select() in LINQ? | A method projecting elements into a new form | It transforms data. |
| 5117 | What is Where() in LINQ? | A method filtering elements | It applies conditions. |
| 5118 | What is OrderBy() in LINQ? | A method sorting ascending | It orders results. |
| 5119 | What is OrderByDescending()? | A method sorting descending | It reverses ordering. |
| 5120 | What is ThenBy()? | A secondary sorting operation | It supports multiple sort keys. |
| 5121 | What is GroupBy()? | A method grouping elements | It creates grouped results. |
| 5122 | What is Join()? | A method combining sequences by keys | It relates data. |
| 5123 | What is GroupJoin()? | A method creating grouped joins | It supports hierarchical data. |
| 5124 | What is Aggregate()? | A method applying a custom accumulation function | It combines values. |
| 5125 | What is Any()? | A method checking whether elements exist | It returns a boolean. |
| 5126 | What is All()? | A method checking all elements against a condition | It validates collections. |
| 5127 | What is Count()? | A method returning element count | It measures collection size. |
| 5128 | What is First()? | A method returning the first element | It throws if empty. |
| 5129 | What is FirstOrDefault()? | A method returning first element or default | It avoids exceptions. |
| 5130 | What is Single()? | A method requiring exactly one element | It validates uniqueness. |
| 5131 | What is SingleOrDefault()? | A method returning one element or default | It handles empty sequences. |
| 5132 | What is Contains()? | A method checking membership | It searches values. |
| 5133 | What is Distinct()? | A method removing duplicates | It returns unique elements. |
| 5134 | What is Skip()? | A method ignoring initial elements | It supports paging. |
| 5135 | What is Take()? | A method selecting a limited number of elements | It supports paging. |
| 5136 | What is SkipWhile()? | A method skipping elements while a condition is true | It provides conditional skipping. |
| 5137 | What is TakeWhile()? | A method taking elements while a condition is true | It provides conditional selection. |
| 5138 | What is ToList()? | A method converting results to a list | It forces execution. |
| 5139 | What is ToArray()? | A method converting results to an array | It materializes data. |
| 5140 | What is ToDictionary()? | A method creating a dictionary from elements | It provides key-based access. |
| 5141 | What is Zip()? | A method combining two sequences element by element | It pairs values. |
| 5142 | What is DefaultIfEmpty()? | A method providing a default element for empty sequences | It prevents empty results. |
| 5143 | What is OfType()? | A method filtering elements by type | It supports type selection. |
| 5144 | What is Cast()? | A method converting elements to a specified type | It performs casting. |
| 5145 | What is Aggregate query? | A query producing a combined result from elements | It performs custom calculations. |
| 5146 | What is projection? | Transforming data into another shape | Select performs projection. |
| 5147 | What is filtering? | Selecting elements based on conditions | Where performs filtering. |
| 5148 | What is sorting? | Ordering elements by criteria | OrderBy performs sorting. |
| 5149 | What is materialization? | Creating actual objects from a query | ToList triggers it. |
| 5150 | What is query composition? | Building queries by combining operations | LINQ supports it. |
| 5151 | What is C# nullable reference type? | A feature identifying possible null reference issues | It improves null safety. |
| 5152 | What is nullable annotation? | Syntax marking reference types as nullable or non-nullable | It provides compiler analysis. |
| 5153 | What is null-forgiving operator? | The ! operator suppressing nullable warnings | It tells compiler a value is not null. |
| 5154 | What is null conditional operator? | The ?. operator safely accessing members | It prevents null exceptions. |
| 5155 | What is null coalescing operator? | The ?? operator providing fallback values | It handles null values. |
| 5156 | What is null coalescing assignment? | The ??= operator assigning only when null | It simplifies initialization. |
| 5157 | What is pattern matching? | A C# feature checking and extracting values by patterns | It improves conditional logic. |
| 5158 | What is type pattern? | A pattern matching based on object type | It performs safe casting. |
| 5159 | What is property pattern? | A pattern matching object properties | It checks object structure. |
| 5160 | What is relational pattern? | A pattern comparing values using operators | It supports expressive conditions. |
| 5161 | What is logical pattern? | A pattern combining conditions with and, or, not | It creates complex matches. |
| 5162 | What is switch expression? | An expression-based switch construct | It returns values directly. |
| 5163 | What is switch statement? | A control structure selecting execution paths | It handles multiple cases. |
| 5164 | What is tuple pattern? | A pattern matching multiple values together | It supports complex branching. |
| 5165 | What is record type? | A C# type designed for immutable data models | It provides value equality. |
| 5166 | What is record class? | A reference type record | It stores immutable-like data. |
| 5167 | What is record struct? | A value type record | It avoids heap allocation. |
| 5168 | What is init accessor? | A property setter allowed only during initialization | It supports immutable objects. |
| 5169 | What is required member? | A member that must be initialized | It enforces object completeness. |
| 5170 | What is with expression? | A syntax creating modified copies of objects | It is common with records. |
| 5171 | What is primary constructor? | A constructor declared with type parameters | It reduces boilerplate. |
| 5172 | What is file-scoped namespace? | A namespace syntax applying to the whole file | It reduces indentation. |
| 5173 | What is global using directive? | A using directive shared across files | It reduces repetition. |
| 5174 | What is implicit using? | Automatically generated using directives | It simplifies projects. |
| 5175 | What is top-level statement? | C# code written without explicit Main method | It simplifies small applications. |
| 5176 | What is async Main? | A Main method supporting asynchronous execution | It enables await at startup. |
| 5177 | What is async modifier? | A keyword enabling asynchronous methods | It works with await. |
| 5178 | What is await keyword? | A keyword waiting for asynchronous completion | It avoids blocking threads. |
| 5179 | What is Task? | A representation of asynchronous work | It supports async programming. |
| 5180 | What is Task<T>? | A task producing a result | It returns asynchronous values. |
| 5181 | What is ValueTask? | A lightweight alternative to Task | It reduces allocations in some cases. |
| 5182 | What is async state machine? | Compiler-generated structure managing async execution | It handles await continuations. |
| 5183 | What is SynchronizationContext? | An abstraction controlling continuation execution context | It affects async behavior. |
| 5184 | What is ConfigureAwait()? | A method controlling synchronization context capture | It improves library performance. |
| 5185 | What is Task.Run()? | A method running work on the thread pool | It schedules background work. |
| 5186 | What is Task.WhenAll()? | A method awaiting multiple tasks together | It runs operations concurrently. |
| 5187 | What is Task.WhenAny()? | A method completing when any task finishes | It supports racing operations. |
| 5188 | What is cancellation token? | A mechanism for cooperative cancellation | It stops asynchronous operations. |
| 5189 | What is CancellationTokenSource? | An object creating cancellation tokens | It triggers cancellation. |
| 5190 | What is OperationCanceledException? | Exception indicating cancelled work | It represents cooperative cancellation. |
| 5191 | What is parallel programming? | Executing multiple operations simultaneously | It improves throughput. |
| 5192 | What is concurrency? | Managing multiple operations overlapping in time | It improves responsiveness. |
| 5193 | What is parallelism? | Executing multiple operations at the same time | It uses multiple processors. |
| 5194 | What is Thread? | A unit of execution managed by the operating system | It performs work. |
| 5195 | What is ThreadPool? | A pool of reusable worker threads | It improves efficiency. |
| 5196 | What is Task Parallel Library? | .NET library for parallel programming | It simplifies concurrency. |
| 5197 | What is Parallel.For()? | A method executing loop iterations in parallel | It improves CPU-bound work. |
| 5198 | What is Parallel.ForEach()? | A method processing collections in parallel | It distributes work. |
| 5199 | What is PLINQ? | Parallel Language Integrated Query | It parallelizes LINQ operations. |
| 5200 | What is lock statement? | A C# mechanism for thread synchronization | It prevents race conditions. |
| 5201 | What is race condition? | A problem caused by uncontrolled concurrent access to shared data | It can produce incorrect results. |
| 5202 | What is deadlock? | A situation where threads wait for each other indefinitely | It stops execution progress. |
| 5203 | What is livelock? | A situation where threads keep responding but make no progress | It wastes resources. |
| 5204 | What is starvation? | A situation where a thread never gets required resources | It delays execution. |
| 5205 | What is thread safety? | Ability of code to work correctly under concurrent execution | It prevents concurrency bugs. |
| 5206 | What is synchronization? | Coordinating access to shared resources | It controls concurrency. |
| 5207 | What is Monitor? | A .NET synchronization primitive | It provides locking support. |
| 5208 | What is Mutex? | A synchronization object allowing one thread across processes | It provides exclusive access. |
| 5209 | What is Semaphore? | A synchronization primitive limiting concurrent access | It controls resource usage. |
| 5210 | What is SemaphoreSlim? | A lightweight semaphore for async scenarios | It supports asynchronous locking. |
| 5211 | What is ReaderWriterLockSlim? | A lock supporting multiple readers and single writers | It optimizes read-heavy scenarios. |
| 5212 | What is Interlocked class? | A class providing atomic operations | It supports lock-free programming. |
| 5213 | What is volatile keyword? | A keyword ensuring field reads are not optimized incorrectly | It supports memory visibility. |
| 5214 | What is immutable object? | An object whose state cannot change after creation | It is naturally thread-safe. |
| 5215 | What is concurrent collection? | A thread-safe collection designed for concurrency | It supports parallel access. |
| 5216 | What is ConcurrentDictionary? | A thread-safe dictionary implementation | It supports concurrent updates. |
| 5217 | What is ConcurrentQueue? | A thread-safe FIFO collection | It supports multiple producers and consumers. |
| 5218 | What is ConcurrentStack? | A thread-safe LIFO collection | It supports concurrent stack operations. |
| 5219 | What is BlockingCollection? | A thread-safe collection supporting blocking operations | It supports producer-consumer scenarios. |
| 5220 | What is Channel<T>? | A high-performance asynchronous communication primitive | It supports producer-consumer patterns. |
| 5221 | What is producer-consumer pattern? | A pattern where producers create data and consumers process it | It separates workloads. |
| 5222 | What is background service? | A long-running hosted .NET process | It performs background tasks. |
| 5223 | What is IHostedService? | An interface for hosted background services | It manages service lifecycle. |
| 5224 | What is BackgroundService? | A base class for long-running background tasks | It simplifies hosted services. |
| 5225 | What is worker service? | A .NET project type for background processing | It runs without UI. |
| 5226 | What is hosted service lifecycle? | The start and stop behavior of background services | It manages execution. |
| 5227 | What is ExecuteAsync()? | Method containing BackgroundService execution logic | It runs background work. |
| 5228 | What is graceful shutdown? | Stopping an application while completing active work | It prevents data loss. |
| 5229 | What is application lifetime? | The lifecycle management of a .NET application | It controls startup and shutdown. |
| 5230 | What is IHostApplicationLifetime? | A service controlling host lifecycle events | It manages application termination. |
| 5231 | What is cancellation during shutdown? | Cooperative stopping using cancellation tokens | It enables graceful termination. |
| 5232 | What is singleton service? | A dependency injection service with one instance | It lives for application lifetime. |
| 5233 | What is scoped service? | A dependency injection service created per scope | It is common for web requests. |
| 5234 | What is transient service? | A dependency injection service created each time requested | It provides new instances. |
| 5235 | What is service lifetime? | The duration a dependency instance exists | DI manages it. |
| 5236 | What is dependency injection container? | A component creating and managing dependencies | It resolves services. |
| 5237 | What is IServiceCollection? | A collection used to register services | It configures DI. |
| 5238 | What is IServiceProvider? | An interface resolving registered services | It creates dependencies. |
| 5239 | What is service registration? | Adding services to the dependency container | It enables injection. |
| 5240 | What is constructor injection? | Providing dependencies through constructors | It is the recommended DI approach. |
| 5241 | What is property injection? | Providing dependencies through properties | It is less common. |
| 5242 | What is method injection? | Providing dependencies through method parameters | It supports specific operations. |
| 5243 | What is dependency inversion? | Depending on abstractions instead of implementations | It reduces coupling. |
| 5244 | What is service locator pattern? | Resolving dependencies manually from a container | It can hide dependencies. |
| 5245 | What is dependency scope? | The lifetime boundary for scoped services | It controls object creation. |
| 5246 | What is scope validation? | Checking invalid dependency lifetime combinations | It prevents DI errors. |
| 5247 | What is captive dependency? | A longer-lived service holding a shorter-lived dependency | It causes lifetime issues. |
| 5248 | What is options pattern? | A .NET configuration approach using strongly typed settings | It improves configuration management. |
| 5249 | What is IOptions<T>? | A service providing configuration values | It supports options pattern. |
| 5250 | What is IOptionsSnapshot<T>? | A scoped options service refreshing values per request | It supports updated settings. |
| 5251 | What is IOptionsMonitor<T>? | A service monitoring configuration changes | It supports dynamic updates. |
| 5252 | What is configuration provider? | A component loading configuration values | It supports different sources. |
| 5253 | What is appsettings.json? | A JSON configuration file in .NET applications | It stores application settings. |
| 5254 | What is appsettings.Development.json? | A development environment configuration file | It overrides development settings. |
| 5255 | What is environment-specific configuration? | Configuration loaded based on environment | It supports different deployments. |
| 5256 | What is IConfiguration? | .NET abstraction for accessing configuration data | It reads application settings. |
| 5257 | What is configuration binding? | Mapping configuration values to objects | It creates strongly typed settings. |
| 5258 | What is secrets.json? | A development file storing sensitive settings | It avoids hardcoded secrets. |
| 5259 | What is user secrets? | A .NET feature storing development secrets securely | It keeps secrets outside source code. |
| 5260 | What is environment name? | A value identifying application environment | Examples are Development and Production. |
| 5261 | What is ASPNETCORE_ENVIRONMENT? | Environment variable selecting ASP.NET Core environment | It controls configuration loading. |
| 5262 | What is Development environment? | An environment for local development | It enables debugging features. |
| 5263 | What is Staging environment? | An environment for pre-production testing | It validates releases. |
| 5264 | What is Production environment? | The live application environment | It serves real users. |
| 5265 | What is middleware? | A component processing HTTP requests and responses | It forms a request pipeline. |
| 5266 | What is middleware pipeline? | Ordered sequence of middleware components | It controls request flow. |
| 5267 | What is RequestDelegate? | A delegate representing the next pipeline step | Middleware uses it. |
| 5268 | What is custom middleware? | User-created middleware component | It adds custom processing. |
| 5269 | What is UseMiddleware()? | Method registering middleware | It adds components to pipeline. |
| 5270 | What is Run()? | Middleware method terminating the pipeline | It does not call next middleware. |
| 5271 | What is Use()? | Middleware method adding processing logic | It can call next. |
| 5272 | What is Map()? | Method branching the middleware pipeline | It handles specific paths. |
| 5273 | What is endpoint routing? | Routing system mapping requests to endpoints | It selects handlers. |
| 5274 | What is UseRouting()? | Middleware enabling route matching | It identifies endpoints. |
| 5275 | What is UseEndpoints()? | Middleware executing matched endpoints | It runs endpoint handlers. |
| 5276 | What is endpoint? | A destination for an HTTP request | It executes application logic. |
| 5277 | What is route? | A pattern matching incoming URLs | It maps requests. |
| 5278 | What is route template? | A pattern defining URL structure | It supports parameterized routes. |
| 5279 | What is route parameter? | A variable segment in a route | It captures values from URLs. |
| 5280 | What is route constraint? | A rule restricting route parameter values | It validates routes. |
| 5281 | What is attribute routing? | Routing defined using attributes | It provides direct route control. |
| 5282 | What is conventional routing? | Routing based on predefined patterns | It follows conventions. |
| 5283 | What is minimal API? | A lightweight way to create HTTP APIs | It reduces boilerplate. |
| 5284 | What is endpoint mapping? | Registering handlers for routes | It connects URLs to code. |
| 5285 | What is MapGet()? | Minimal API method mapping GET endpoints | It creates GET handlers. |
| 5286 | What is MapPost()? | Minimal API method mapping POST endpoints | It creates POST handlers. |
| 5287 | What is MapPut()? | Minimal API method mapping PUT endpoints | It creates update handlers. |
| 5288 | What is MapDelete()? | Minimal API method mapping DELETE endpoints | It creates delete handlers. |
| 5289 | What is route group? | A group of endpoints sharing configuration | It reduces duplication. |
| 5290 | What is endpoint filter? | A component running around endpoint execution | It supports cross-cutting logic. |
| 5291 | What is action filter? | MVC filter running around controller actions | It adds action processing. |
| 5292 | What is authorization filter? | MVC filter checking permissions | It protects actions. |
| 5293 | What is resource filter? | MVC filter running early in request processing | It controls resource execution. |
| 5294 | What is result filter? | MVC filter running around action results | It modifies responses. |
| 5295 | What is exception filter? | MVC filter handling action exceptions | It centralizes error handling. |
| 5296 | What is model binding? | Mapping request data to action parameters | It simplifies input handling. |
| 5297 | What is model validation? | Checking model data against rules | It ensures valid input. |
| 5298 | What is ModelState? | Object containing binding and validation results | It reports errors. |
| 5299 | What is data annotation? | Attribute-based validation metadata | It defines model rules. |
| 5300 | What is FluentValidation? | A .NET validation library using fluent rules | It separates validation logic. |
| 5301 | What is ASP.NET Core MVC? | A framework for building web applications using Model-View-Controller pattern | It separates application concerns. |
| 5302 | What is MVC pattern? | A pattern separating Model, View, and Controller responsibilities | It organizes web applications. |
| 5303 | What is Model in MVC? | The data and business logic representation | It manages application state. |
| 5304 | What is View in MVC? | The UI representation layer | It displays data to users. |
| 5305 | What is Controller in MVC? | A component handling HTTP requests | It coordinates application behavior. |
| 5306 | What is Razor view? | A server-rendered HTML template using Razor syntax | It generates dynamic pages. |
| 5307 | What is Razor syntax? | A syntax combining C# and HTML | It creates dynamic UI. |
| 5308 | What is Razor Page? | A page-focused ASP.NET Core UI model | It simplifies page-based applications. |
| 5309 | What is PageModel? | The C# class behind a Razor Page | It contains page logic. |
| 5310 | What is ViewModel? | A model designed specifically for UI display | It separates UI from domain models. |
| 5311 | What is Partial View? | A reusable Razor view fragment | It reduces duplication. |
| 5312 | What is Layout page? | A shared Razor page template | It provides common UI structure. |
| 5313 | What is View Component? | A reusable UI component with logic | It combines view and behavior. |
| 5314 | What is Tag Helper? | A server-side component simplifying HTML generation | It extends Razor syntax. |
| 5315 | What is HTML Helper? | A helper method generating HTML in MVC views | It simplifies markup creation. |
| 5316 | What is TempData? | Temporary storage between requests | It commonly uses session or cookies. |
| 5317 | What is ViewData? | A dictionary passing data from controller to view | It is weakly typed. |
| 5318 | What is ViewBag? | A dynamic wrapper around ViewData | It provides easier syntax. |
| 5319 | What is Session state? | Server-side storage for user-specific data | It persists across requests. |
| 5320 | What is Cookie? | Small data stored in the browser | It maintains client-side state. |
| 5321 | What is Response cookie? | A cookie sent from server to client | It stores client information. |
| 5322 | What is Request cookie? | A cookie sent from client to server | It provides stored values. |
| 5323 | What is Antiforgery token? | A token preventing CSRF attacks | It validates form submissions. |
| 5324 | What is Razor encoding? | Automatic HTML encoding in Razor | It prevents XSS. |
| 5325 | What is IActionResult? | MVC abstraction representing an action response | It supports multiple response types. |
| 5326 | What is ActionResult<T>? | Strongly typed controller response wrapper | It supports typed APIs. |
| 5327 | What is ControllerBase? | Base class for API controllers | It provides API helpers. |
| 5328 | What is Controller? | MVC controller base class with view support | It handles web requests. |
| 5329 | What is ApiController attribute? | Attribute enabling API-specific behaviors | It improves API development. |
| 5330 | What is automatic model validation? | Automatic validation performed by ASP.NET Core | It checks incoming models. |
| 5331 | What is ProblemDetails? | Standard format for HTTP API errors | It improves error responses. |
| 5332 | What is ValidationProblemDetails? | ProblemDetails containing validation errors | It represents invalid models. |
| 5333 | What is exception handling middleware? | Middleware handling unhandled exceptions | It creates consistent error responses. |
| 5334 | What is Developer Exception Page? | Development error display middleware | It helps debugging. |
| 5335 | What is UseExceptionHandler()? | Middleware configuring production error handling | It handles failures safely. |
| 5336 | What is global exception handling? | Centralized application error processing | It avoids duplicated try-catch logic. |
| 5337 | What is MVC filter pipeline? | Ordered execution of MVC filters | It supports cross-cutting behavior. |
| 5338 | What is authorization attribute? | Attribute restricting access to actions | It enforces security rules. |
| 5339 | What is AllowAnonymous attribute? | Attribute allowing access without authentication | It bypasses authorization. |
| 5340 | What is HttpGet attribute? | Attribute mapping actions to GET requests | It defines API endpoints. |
| 5341 | What is HttpPost attribute? | Attribute mapping actions to POST requests | It defines create operations. |
| 5342 | What is HttpPut attribute? | Attribute mapping actions to PUT requests | It defines update operations. |
| 5343 | What is HttpDelete attribute? | Attribute mapping actions to DELETE requests | It defines delete operations. |
| 5344 | What is FromBody attribute? | Attribute binding data from request body | It reads payloads. |
| 5345 | What is FromQuery attribute? | Attribute binding data from query string | It reads URL parameters. |
| 5346 | What is FromRoute attribute? | Attribute binding data from route values | It reads route parameters. |
| 5347 | What is FromHeader attribute? | Attribute binding data from headers | It reads request headers. |
| 5348 | What is FromServices attribute? | Attribute injecting services into actions | It resolves dependencies. |
| 5349 | What is Api Explorer? | Service describing API endpoints | It supports documentation tools. |
| 5350 | What is ActionDescriptor? | Metadata describing controller actions | It supports MVC processing. |
| 5351 | What is ASP.NET Core hosting model? | The way an ASP.NET Core application runs | It manages application startup and lifetime. |
| 5352 | What is Kestrel? | A cross-platform web server for ASP.NET Core | It handles HTTP requests. |
| 5353 | What is IIS? | Internet Information Services web server | It hosts ASP.NET applications on Windows. |
| 5354 | What is IIS reverse proxy? | IIS forwarding requests to ASP.NET Core | It provides hosting integration. |
| 5355 | What is WebListener? | A Windows HTTP server implementation | It supports Windows-specific hosting. |
| 5356 | What is Generic Host? | A .NET hosting model for applications | It manages services and configuration. |
| 5357 | What is Web Host? | The ASP.NET Core hosting abstraction | It configures web applications. |
| 5358 | What is HostBuilder? | A builder configuring .NET hosting | It creates application hosts. |
| 5359 | What is WebApplicationBuilder? | A simplified ASP.NET Core application builder | It configures modern web apps. |
| 5360 | What is WebApplication? | The ASP.NET Core application pipeline | It runs web applications. |
| 5361 | What is Program.cs? | The startup entry file in modern .NET applications | It configures application services. |
| 5362 | What is Startup class? | A class configuring ASP.NET Core applications | Older versions use it. |
| 5363 | What is ConfigureServices method? | A method registering application services | It configures dependency injection. |
| 5364 | What is Configure method? | A method configuring HTTP middleware pipeline | It defines request processing. |
| 5365 | What is app builder? | An object configuring application middleware | It builds the pipeline. |
| 5366 | What is service collection? | A collection of dependency registrations | It configures DI. |
| 5367 | What is host configuration? | Configuration controlling application hosting | It defines host behavior. |
| 5368 | What is application configuration? | Settings used by the application | It controls runtime behavior. |
| 5369 | What is logging configuration? | Settings controlling logging behavior | It manages log output. |
| 5370 | What is launchSettings.json? | A development launch configuration file | It defines local profiles. |
| 5371 | What is launch profile? | A configuration for running an application | It defines startup options. |
| 5372 | What is HTTPS redirection? | Redirecting HTTP requests to HTTPS | It improves security. |
| 5373 | What is HttpsRedirectionMiddleware? | Middleware enforcing HTTPS usage | It redirects insecure requests. |
| 5374 | What is static file middleware? | Middleware serving static files | It serves CSS, JS, and images. |
| 5375 | What is UseStaticFiles()? | Method enabling static file serving | It adds static file middleware. |
| 5376 | What is wwwroot folder? | Default folder for static web assets | It contains public files. |
| 5377 | What is default files middleware? | Middleware serving default documents | It enables index pages. |
| 5378 | What is file provider? | Abstraction for accessing files | It supports different storage sources. |
| 5379 | What is IFileProvider? | Interface for file system access | It abstracts file operations. |
| 5380 | What is physical file provider? | File provider accessing physical files | It works with local storage. |
| 5381 | What is embedded file provider? | File provider accessing embedded resources | It reads assembly resources. |
| 5382 | What is composite file provider? | Provider combining multiple file providers | It aggregates sources. |
| 5383 | What is response caching? | Storing responses to improve performance | It reduces processing. |
| 5384 | What is ResponseCache attribute? | Attribute configuring response caching | It controls cache behavior. |
| 5385 | What is output caching? | Server-side caching of generated responses | It improves performance. |
| 5386 | What is OutputCache attribute? | Attribute configuring output caching | It controls cached responses. |
| 5387 | What is memory cache? | In-memory application cache | It stores frequently used data. |
| 5388 | What is distributed cache? | Cache shared across multiple servers | It supports distributed applications. |
| 5389 | What is IDistributedCache? | .NET abstraction for distributed caching | It supports multiple cache providers. |
| 5390 | What is IMemoryCache? | .NET interface for memory caching | It stores local cache data. |
| 5391 | What is cache expiration? | The time after which cached data becomes invalid | It controls freshness. |
| 5392 | What is absolute expiration? | Cache expiration at a fixed time | It limits lifetime. |
| 5393 | What is sliding expiration? | Cache expiration extended by access | It keeps frequently used data. |
| 5394 | What is cache invalidation? | Removing outdated cache entries | It maintains correctness. |
| 5395 | What is cache-aside pattern? | Loading data into cache on demand | It controls cache usage. |
| 5396 | What is Redis? | An in-memory data store used for caching | It supports distributed caching. |
| 5397 | What is Redis cache provider? | A provider storing .NET cache data in Redis | It enables shared caching. |
| 5398 | What is distributed session? | Session storage shared across servers | It supports scaling. |
| 5399 | What is sticky session? | Routing users to the same server instance | It simplifies session handling. |
| 5400 | What is stateless application? | An application that does not store client state locally | It scales easily. |
| 5401 | What is stateful application? | An application that maintains user or process state | It depends on stored state. |
| 5402 | What is scalability? | Ability of a system to handle increased load | It supports growth. |
| 5403 | What is horizontal scaling? | Adding more application instances | It improves capacity. |
| 5404 | What is vertical scaling? | Increasing resources of an existing machine | It improves individual capacity. |
| 5405 | What is load balancing? | Distributing requests across servers | It improves availability. |
| 5406 | What is load balancer? | A component distributing traffic among instances | It manages workloads. |
| 5407 | What is health-based routing? | Routing traffic only to healthy instances | It improves reliability. |
| 5408 | What is round-robin load balancing? | Distributing requests sequentially among servers | It provides simple balancing. |
| 5409 | What is least connections algorithm? | Routing traffic to servers with fewer connections | It balances active load. |
| 5410 | What is sticky session load balancing? | Keeping a user on the same server | It maintains local state. |
| 5411 | What is cloud-native application? | An application designed for cloud environments | It uses scalable practices. |
| 5412 | What is twelve-factor app? | A methodology for building cloud applications | It promotes portability. |
| 5413 | What is containerization? | Packaging applications with dependencies | It improves consistency. |
| 5414 | What is container? | A lightweight isolated application environment | It packages software. |
| 5415 | What is Docker? | A platform for building and running containers | It manages containerized apps. |
| 5416 | What is Docker image? | A template used to create containers | It contains application files. |
| 5417 | What is Docker container? | A running instance of an image | It executes the application. |
| 5418 | What is Dockerfile? | A file defining image creation steps | It automates image builds. |
| 5419 | What is Docker registry? | A repository storing container images | It distributes images. |
| 5420 | What is Docker Hub? | A public container image registry | It hosts Docker images. |
| 5421 | What is container orchestration? | Managing multiple containers automatically | It handles deployment and scaling. |
| 5422 | What is Kubernetes? | A container orchestration platform | It manages container workloads. |
| 5423 | What is Kubernetes pod? | The smallest deployable Kubernetes unit | It runs one or more containers. |
| 5424 | What is Kubernetes service? | A networking abstraction exposing pods | It enables communication. |
| 5425 | What is Kubernetes deployment? | A resource managing application replicas | It handles updates and scaling. |
| 5426 | What is Kubernetes namespace? | A logical cluster partition | It separates resources. |
| 5427 | What is Kubernetes config map? | A resource storing configuration data | It separates configuration from code. |
| 5428 | What is Kubernetes secret? | A resource storing sensitive configuration | It protects credentials. |
| 5429 | What is Kubernetes ingress? | A resource managing external HTTP access | It routes traffic. |
| 5430 | What is Kubernetes readiness probe? | A check determining if a pod can receive traffic | It controls routing. |
| 5431 | What is Kubernetes liveness probe? | A check determining if a pod is healthy | It triggers restarts. |
| 5432 | What is Kubernetes replica set? | A resource maintaining pod replicas | It ensures availability. |
| 5433 | What is Kubernetes rolling update? | Gradual replacement of application versions | It enables zero-downtime deployment. |
| 5434 | What is Kubernetes cluster? | A group of machines running Kubernetes workloads | It hosts containers. |
| 5435 | What is node in Kubernetes? | A machine running Kubernetes workloads | It hosts pods. |
| 5436 | What is control plane? | Kubernetes management components | It controls the cluster. |
| 5437 | What is worker node? | A machine executing application workloads | It runs containers. |
| 5438 | What is service mesh? | A network layer managing service communication | It adds observability and security. |
| 5439 | What is sidecar pattern? | A pattern running helper components beside applications | It extends functionality. |
| 5440 | What is infrastructure as code? | Managing infrastructure through code definitions | It enables automation. |
| 5441 | What is Terraform? | An infrastructure as code tool | It provisions cloud resources. |
| 5442 | What is ARM template? | Azure infrastructure definition format | It deploys Azure resources. |
| 5443 | What is Bicep? | Azure infrastructure as code language | It simplifies ARM templates. |
| 5444 | What is cloud provisioning? | Creating and configuring cloud resources | It automates environments. |
| 5445 | What is Azure App Service? | A managed platform for hosting web applications | It simplifies deployment. |
| 5446 | What is Azure Functions? | A serverless compute service | It runs event-driven code. |
| 5447 | What is serverless computing? | Running code without managing servers | It scales automatically. |
| 5448 | What is Azure Container Apps? | A managed container application platform | It runs container workloads. |
| 5449 | What is Azure Kubernetes Service? | Managed Kubernetes service in Azure | It hosts containerized applications. |
| 5450 | What is cloud scalability? | Ability to automatically adjust resources | It handles changing demand. |
| 5451 | What is Azure Virtual Machine? | A cloud-based virtual server | It runs applications in Azure. |
| 5452 | What is Azure VM Scale Set? | A service managing groups of virtual machines | It enables automatic scaling. |
| 5453 | What is Azure Load Balancer? | A service distributing network traffic | It improves availability. |
| 5454 | What is Azure Application Gateway? | A web traffic load balancer with routing features | It supports HTTP-based applications. |
| 5455 | What is Azure Front Door? | A global application delivery service | It provides acceleration and routing. |
| 5456 | What is Azure CDN? | A content delivery network service | It caches content near users. |
| 5457 | What is Azure Storage? | A cloud storage platform | It stores application data. |
| 5458 | What is Azure Blob Storage? | Object storage service in Azure | It stores unstructured data. |
| 5459 | What is Blob container? | A logical group of blobs | It organizes storage objects. |
| 5460 | What is Azure File Storage? | Managed file share service | It provides SMB-based storage. |
| 5461 | What is Azure Queue Storage? | A message queue storage service | It supports asynchronous processing. |
| 5462 | What is Azure Table Storage? | NoSQL key-value storage service | It stores structured data. |
| 5463 | What is Azure Managed Identity? | Identity service for Azure resources | It avoids storing credentials. |
| 5464 | What is Azure Service Principal? | An identity for applications and automation | It enables resource access. |
| 5465 | What is Azure RBAC? | Role-Based Access Control in Azure | It manages permissions. |
| 5466 | What is Azure Resource Group? | A container for related Azure resources | It organizes deployments. |
| 5467 | What is Azure Subscription? | A billing and management boundary in Azure | It contains resources. |
| 5468 | What is Azure Tenant? | An organization identity boundary | It hosts Microsoft Entra identities. |
| 5469 | What is Microsoft Entra ID? | Cloud identity and access management service | It manages users and applications. |
| 5470 | What is Azure Key Vault? | A service storing secrets and cryptographic keys | It protects sensitive data. |
| 5471 | What is Azure App Configuration? | A service managing application settings | It centralizes configuration. |
| 5472 | What is Azure Monitor? | A monitoring platform for Azure resources | It collects telemetry. |
| 5473 | What is Log Analytics Workspace? | A workspace storing monitoring data | It supports queries and analysis. |
| 5474 | What is Azure Application Insights? | Application monitoring service | It tracks application performance. |
| 5475 | What is Azure Alert? | A notification rule based on conditions | It detects problems. |
| 5476 | What is Azure Dashboard? | A customizable monitoring view | It displays resource information. |
| 5477 | What is Azure DevOps? | A platform for development lifecycle management | It supports CI/CD. |
| 5478 | What is Azure Repos? | A source control service | It hosts Git repositories. |
| 5479 | What is Azure Pipelines? | A CI/CD automation service | It builds and deploys applications. |
| 5480 | What is Azure Boards? | A work tracking service | It manages tasks and planning. |
| 5481 | What is Azure Artifacts? | A package management service | It hosts dependencies. |
| 5482 | What is Azure Test Plans? | A testing management service | It supports manual and exploratory testing. |
| 5483 | What is CI? | Continuous Integration | It automatically builds and tests code changes. |
| 5484 | What is CD? | Continuous Delivery or Deployment | It automates software delivery. |
| 5485 | What is CI/CD pipeline? | Automated workflow for building, testing, and deploying software | It improves release speed. |
| 5486 | What is build pipeline? | Pipeline producing application artifacts | It compiles and tests code. |
| 5487 | What is release pipeline? | Pipeline deploying applications | It manages releases. |
| 5488 | What is deployment stage? | A step delivering software to an environment | It controls releases. |
| 5489 | What is artifact? | A build output used for deployment | It packages application results. |
| 5490 | What is artifact repository? | Storage location for build outputs | It manages packages. |
| 5491 | What is package manager? | Tool managing software dependencies | It installs libraries. |
| 5492 | What is NuGet? | .NET package management system | It distributes libraries. |
| 5493 | What is NuGet package? | A reusable .NET library package | It contains compiled code and metadata. |
| 5494 | What is NuGet feed? | A source hosting NuGet packages | It provides dependencies. |
| 5495 | What is package versioning? | Managing different versions of dependencies | It controls compatibility. |
| 5496 | What is semantic versioning? | Versioning format using MAJOR.MINOR.PATCH | It communicates compatibility. |
| 5497 | What is dependency management? | Managing external libraries and versions | It maintains application stability. |
| 5498 | What is package restore? | Downloading required dependencies | It prepares builds. |
| 5499 | What is lock file? | A file recording exact dependency versions | It improves reproducibility. |
| 5500 | What is reproducible build? | A build producing identical output from identical source | It improves reliability. |
| 5501 | What is software architecture? | The high-level structure and organization of a software system | It defines components and interactions. |
| 5502 | What is architectural pattern? | A reusable solution for organizing software structure | It guides system design. |
| 5503 | What is layered architecture? | Architecture dividing software into logical layers | It separates responsibilities. |
| 5504 | What is presentation layer? | Layer handling user interaction | It manages UI concerns. |
| 5505 | What is business layer? | Layer containing business rules | It implements domain logic. |
| 5506 | What is data access layer? | Layer communicating with data sources | It isolates persistence logic. |
| 5507 | What is three-tier architecture? | Architecture with presentation, business, and data tiers | It separates application responsibilities. |
| 5508 | What is n-tier architecture? | Architecture using multiple logical tiers | It supports separation of concerns. |
| 5509 | What is clean architecture? | Architecture separating business rules from external concerns | It improves maintainability. |
| 5510 | What is onion architecture? | Architecture organizing dependencies toward the core domain | It protects business logic. |
| 5511 | What is hexagonal architecture? | Architecture using ports and adapters | It isolates external systems. |
| 5512 | What is domain-driven design? | Design approach focusing on business domains | It models complex systems. |
| 5513 | What is DDD? | Domain-Driven Design abbreviation | It emphasizes domain models. |
| 5514 | What is domain model? | A model representing business concepts | It captures domain rules. |
| 5515 | What is entity in DDD? | Object with a unique identity over time | It represents business objects. |
| 5516 | What is value object? | Object defined by its values rather than identity | It is usually immutable. |
| 5517 | What is aggregate? | A group of related domain objects managed together | It maintains consistency. |
| 5518 | What is aggregate root? | The main entity controlling an aggregate | It enforces rules. |
| 5519 | What is domain service? | Service containing domain logic not belonging to an entity | It models operations. |
| 5520 | What is repository pattern? | Pattern abstracting data access | It separates persistence concerns. |
| 5521 | What is unit of work pattern? | Pattern managing multiple operations as one transaction | It maintains consistency. |
| 5522 | What is CQRS? | Command Query Responsibility Segregation | It separates reads and writes. |
| 5523 | What is command? | An operation requesting a state change | It modifies data. |
| 5524 | What is query? | An operation retrieving data | It does not change state. |
| 5525 | What is mediator pattern? | Pattern allowing objects to communicate through a mediator | It reduces coupling. |
| 5526 | What is MediatR? | A .NET library implementing mediator pattern | It supports CQRS implementations. |
| 5527 | What is command handler? | Component processing commands | It executes business actions. |
| 5528 | What is query handler? | Component processing queries | It returns requested data. |
| 5529 | What is pipeline behavior? | Middleware-like processing around MediatR requests | It adds cross-cutting logic. |
| 5530 | What is vertical slice architecture? | Architecture organizing code by business feature | It improves maintainability. |
| 5531 | What is feature folder structure? | Organizing code by application features | It improves navigation. |
| 5532 | What is modular monolith? | A single application divided into independent modules | It combines simplicity and separation. |
| 5533 | What is monolithic architecture? | Architecture where all functionality is deployed together | It is simple to deploy initially. |
| 5534 | What is microservices architecture? | Architecture using independently deployable services | It supports scalability. |
| 5535 | What is microservice? | A small independent service focused on a business capability | It can be deployed separately. |
| 5536 | What is service boundary? | A separation point between system components | It defines ownership. |
| 5537 | What is bounded context? | A DDD boundary where a model has specific meaning | It limits complexity. |
| 5538 | What is API gateway pattern? | A single entry point for multiple services | It manages client communication. |
| 5539 | What is backend-for-frontend pattern? | Separate backend services for different clients | It optimizes client needs. |
| 5540 | What is event-driven architecture? | Architecture based on events and message communication | It enables loose coupling. |
| 5541 | What is event? | A record of something that happened | It communicates changes. |
| 5542 | What is domain event? | An event representing a business occurrence | It notifies domain changes. |
| 5543 | What is event handler? | Component processing events | It reacts to messages. |
| 5544 | What is event publisher? | Component sending events | It distributes notifications. |
| 5545 | What is message broker? | System transferring messages between applications | It enables asynchronous communication. |
| 5546 | What is RabbitMQ? | A message broker supporting queues and exchanges | It enables messaging. |
| 5547 | What is Apache Kafka? | A distributed event streaming platform | It handles large-scale events. |
| 5548 | What is Azure Service Bus? | Cloud messaging service | It supports reliable communication. |
| 5549 | What is message queue? | A queue storing messages for processing | It decouples systems. |
| 5550 | What is publish-subscribe pattern? | Pattern where publishers send messages to subscribers | It supports event distribution. |
| 5551 | What is eventual consistency? | A model where data becomes consistent over time | It supports distributed systems. |
| 5552 | What is strong consistency? | A model where all reads see the latest data | It provides immediate consistency. |
| 5553 | What is distributed system? | A system whose components run across multiple machines | It requires coordination. |
| 5554 | What is CAP theorem? | A theorem describing trade-offs between consistency, availability, and partition tolerance | It guides distributed design. |
| 5555 | What is partition tolerance? | Ability to operate despite network failures | It is important in distributed systems. |
| 5556 | What is consistency in CAP? | Guarantee that all nodes see the same data | It maintains correctness. |
| 5557 | What is availability in CAP? | Guarantee that requests receive responses | It supports continuous service. |
| 5558 | What is distributed transaction? | A transaction spanning multiple systems | It coordinates multiple resources. |
| 5559 | What is two-phase commit? | A distributed transaction coordination protocol | It ensures agreement. |
| 5560 | What is saga pattern? | A pattern managing distributed transactions through steps | It uses compensating actions. |
| 5561 | What is compensating transaction? | An operation reversing a previous action | It handles failures. |
| 5562 | What is idempotency? | Ability to perform an operation multiple times with the same result | It improves reliability. |
| 5563 | What is idempotency key? | A unique identifier preventing duplicate operations | It avoids repeated processing. |
| 5564 | What is retry-safe operation? | An operation that can be repeated safely | It supports resilience. |
| 5565 | What is outbox pattern? | Pattern storing events with database changes before publishing | It improves reliability. |
| 5566 | What is inbox pattern? | Pattern tracking received messages | It prevents duplicate processing. |
| 5567 | What is event sourcing? | Storing state changes as a sequence of events | It preserves history. |
| 5568 | What is event store? | Storage containing domain events | It supports event sourcing. |
| 5569 | What is snapshotting? | Saving current state to reduce event replay time | It improves performance. |
| 5570 | What is audit trail? | A record of system activities | It supports tracking and compliance. |
| 5571 | What is logging versus auditing? | Logging records technical events; auditing records business actions | They serve different purposes. |
| 5572 | What is transaction? | A group of operations executed as a unit | It maintains data consistency. |
| 5573 | What is ACID? | Properties of reliable database transactions | It ensures correctness. |
| 5574 | What is atomicity? | Transaction property where all operations succeed or fail together | It prevents partial updates. |
| 5575 | What is consistency in ACID? | Transaction property maintaining valid data states | It preserves rules. |
| 5576 | What is isolation? | Transaction property controlling concurrent access | It prevents interference. |
| 5577 | What is durability? | Transaction property ensuring committed data persists | It protects saved changes. |
| 5578 | What is isolation level? | Rules controlling transaction visibility | It affects concurrency. |
| 5579 | What is Read Uncommitted? | Isolation level allowing dirty reads | It provides low consistency. |
| 5580 | What is Read Committed? | Isolation level preventing dirty reads | It is commonly used. |
| 5581 | What is Repeatable Read? | Isolation level preventing repeated read changes | It improves consistency. |
| 5582 | What is Serializable? | Highest isolation level preventing transaction conflicts | It reduces concurrency. |
| 5583 | What is Snapshot Isolation? | Isolation using row versions for consistent reads | It improves concurrency. |
| 5584 | What is optimistic concurrency? | Assuming conflicts are rare and checking during update | It improves scalability. |
| 5585 | What is pessimistic concurrency? | Locking data to prevent conflicts | It controls access. |
| 5586 | What is concurrency token? | A value used to detect conflicting updates | It supports optimistic concurrency. |
| 5587 | What is row version? | A database value tracking record changes | It detects modifications. |
| 5588 | What is EF Core concurrency exception? | Exception raised when concurrent update conflicts occur | It requires handling. |
| 5589 | What is migration? | A database schema change managed through code | It evolves databases. |
| 5590 | What is EF Core migration? | Migration system in Entity Framework Core | It updates database schema. |
| 5591 | What is migration history table? | Table tracking applied migrations | It manages schema versions. |
| 5592 | What is database-first approach? | Creating models from an existing database | It starts with data schema. |
| 5593 | What is code-first approach? | Creating database schema from application models | It starts with code. |
| 5594 | What is model-first approach? | Designing models before generating database | It focuses on conceptual design. |
| 5595 | What is Entity Framework Core? | An object-relational mapper for .NET | It simplifies database access. |
| 5596 | What is DbContext? | EF Core class managing database interaction | It tracks entities. |
| 5597 | What is DbSet<T>? | EF Core collection representing an entity set | It queries and updates data. |
| 5598 | What is entity tracking? | EF Core feature monitoring entity changes | It enables updates. |
| 5599 | What is change tracker? | EF Core component tracking entity states | It manages persistence. |
| 5600 | What is entity state? | Current tracking status of an entity | It controls database operations. |
| 5601 | What is Added entity state? | EF Core state for new entities | It inserts records during SaveChanges. |
| 5602 | What is Modified entity state? | EF Core state for changed entities | It updates records during SaveChanges. |
| 5603 | What is Deleted entity state? | EF Core state for removed entities | It deletes records during SaveChanges. |
| 5604 | What is Unchanged entity state? | EF Core state for tracked entities without changes | It requires no database action. |
| 5605 | What is Detached entity state? | EF Core state for entities not tracked | It is outside change tracking. |
| 5606 | What is SaveChanges()? | EF Core method persisting changes | It executes database commands. |
| 5607 | What is SaveChangesAsync()? | Async EF Core persistence method | It avoids blocking threads. |
| 5608 | What is AsNoTracking()? | EF Core method disabling tracking | It improves read performance. |
| 5609 | What is eager loading? | Loading related data with the main query | It uses Include(). |
| 5610 | What is lazy loading? | Loading related data when accessed | It delays database queries. |
| 5611 | What is explicit loading? | Loading related data manually | It gives control over queries. |
| 5612 | What is Include()? | EF Core method loading related entities | It performs eager loading. |
| 5613 | What is ThenInclude()? | EF Core method loading nested relationships | It extends Include(). |
| 5614 | What is navigation property? | Property representing entity relationships | It connects related entities. |
| 5615 | What is relationship mapping? | Defining connections between entities | It configures database relations. |
| 5616 | What is one-to-one relationship? | Relationship where each entity has one related entity | It represents unique associations. |
| 5617 | What is one-to-many relationship? | Relationship where one entity has many related entities | It is common in databases. |
| 5618 | What is many-to-many relationship? | Relationship where both sides have multiple entities | EF Core supports it directly. |
| 5619 | What is foreign key? | Column referencing another table's primary key | It creates relationships. |
| 5620 | What is primary key? | Unique identifier for a database row | It identifies records. |
| 5621 | What is alternate key? | Additional unique identifier in EF Core | It provides uniqueness. |
| 5622 | What is composite key? | Key made from multiple columns | It identifies records using combinations. |
| 5623 | What is keyless entity? | EF Core entity without a primary key | It is often used for queries. |
| 5624 | What is shadow property? | EF Core property not defined in the CLR class | It exists only in the model. |
| 5625 | What is owned entity? | Entity whose lifecycle belongs to another entity | It models value objects. |
| 5626 | What is table splitting? | Mapping multiple entities to one table | It shares storage. |
| 5627 | What is entity splitting? | Mapping one entity across multiple tables | It separates storage. |
| 5628 | What is inheritance mapping? | Mapping class hierarchies to database tables | It supports object inheritance. |
| 5629 | What is TPH inheritance? | Table-per-hierarchy mapping | It uses one table. |
| 5630 | What is TPT inheritance? | Table-per-type mapping | It uses multiple tables. |
| 5631 | What is TPC inheritance? | Table-per-concrete-type mapping | It creates separate tables. |
| 5632 | What is LINQ translation? | Converting LINQ expressions into database queries | Providers perform translation. |
| 5633 | What is query execution plan? | Database strategy for executing queries | It affects performance. |
| 5634 | What is query optimization? | Improving database query performance | It reduces execution cost. |
| 5635 | What is database index? | Data structure improving lookup speed | It accelerates queries. |
| 5636 | What is clustered index? | Index determining physical row order | It affects storage layout. |
| 5637 | What is non-clustered index? | Separate index structure referencing data rows | It improves searching. |
| 5638 | What is covering index? | Index containing all required query columns | It avoids extra lookups. |
| 5639 | What is database normalization? | Organizing data to reduce duplication | It improves consistency. |
| 5640 | What is denormalization? | Adding duplication for performance | It improves read speed. |
| 5641 | What is SQL injection? | Attack inserting malicious SQL through input | It compromises databases. |
| 5642 | What is parameterized query? | Query using parameters instead of string concatenation | It prevents SQL injection. |
| 5643 | What is stored procedure? | Predefined SQL code stored in database | It encapsulates operations. |
| 5644 | What is view in database? | Virtual table based on a query | It simplifies data access. |
| 5645 | What is database trigger? | Code automatically executed by database events | It enforces automatic actions. |
| 5646 | What is connection pool? | Reusable database connections managed by provider | It improves performance. |
| 5647 | What is database timeout? | Maximum time allowed for database operations | It prevents hanging requests. |
| 5648 | What is retry execution strategy? | Automatic retry mechanism for transient database failures | It improves reliability. |
| 5649 | What is transaction scope? | Ambient transaction management mechanism | It coordinates operations. |
| 5650 | What is distributed database? | Database spread across multiple locations | It supports large-scale systems. |
| 5651 | What is SQL Server? | A relational database management system from Microsoft | It stores and manages structured data. |
| 5652 | What is PostgreSQL? | An open-source relational database system | It supports advanced SQL features. |
| 5653 | What is MySQL? | A popular relational database system | It is widely used for web applications. |
| 5654 | What is SQLite? | A lightweight embedded relational database | It runs without a separate server. |
| 5655 | What is NoSQL database? | A database designed for non-relational data models | It supports flexible schemas. |
| 5656 | What is document database? | A NoSQL database storing document objects | It handles flexible data structures. |
| 5657 | What is MongoDB? | A document-oriented NoSQL database | It stores JSON-like documents. |
| 5658 | What is key-value database? | A database storing data as key and value pairs | It provides fast lookups. |
| 5659 | What is Redis? | An in-memory key-value data store | It supports caching and messaging. |
| 5660 | What is graph database? | A database storing nodes and relationships | It models connected data. |
| 5661 | What is database replication? | Copying data between database servers | It improves availability. |
| 5662 | What is database sharding? | Splitting data across multiple databases | It improves scalability. |
| 5663 | What is partitioning? | Dividing database data into smaller sections | It improves management and performance. |
| 5664 | What is horizontal partitioning? | Splitting rows across partitions | It distributes data. |
| 5665 | What is vertical partitioning? | Splitting columns across partitions | It separates data storage. |
| 5666 | What is database backup? | Creating a copy of database data | It supports recovery. |
| 5667 | What is database restore? | Recovering data from a backup | It restores availability. |
| 5668 | What is point-in-time recovery? | Restoring a database to a specific moment | It minimizes data loss. |
| 5669 | What is disaster recovery? | Process for recovering systems after major failures | It ensures business continuity. |
| 5670 | What is RPO? | Recovery Point Objective | It defines acceptable data loss. |
| 5671 | What is RTO? | Recovery Time Objective | It defines acceptable recovery time. |
| 5672 | What is high availability? | System design minimizing downtime | It improves service reliability. |
| 5673 | What is failover? | Switching to a backup system after failure | It maintains availability. |
| 5674 | What is active-passive architecture? | Architecture with standby systems | It provides backup capacity. |
| 5675 | What is active-active architecture? | Architecture where multiple systems serve traffic | It improves availability. |
| 5676 | What is database migration tool? | Tool managing schema changes | It automates database updates. |
| 5677 | What is Fluent API in EF Core? | Code-based model configuration approach | It defines mappings. |
| 5678 | What is OnModelCreating()? | EF Core method configuring the model | It defines database mappings. |
| 5679 | What is ModelBuilder? | EF Core object configuring entity models | It supports Fluent API. |
| 5680 | What is convention-based configuration? | EF Core automatic model configuration | It reduces manual setup. |
| 5681 | What is data annotation mapping? | Entity configuration using attributes | It defines simple mappings. |
| 5682 | What is migration command? | Command creating or applying schema changes | It manages database versions. |
| 5683 | What is EnsureCreated()? | EF Core method creating a database directly | It bypasses migrations. |
| 5684 | What is EnsureDeleted()? | EF Core method deleting a database | It removes database schema. |
| 5685 | What is database seeding? | Adding initial data automatically | It prepares application data. |
| 5686 | What is EF Core interceptor? | Component intercepting EF Core operations | It enables cross-cutting behavior. |
| 5687 | What is query interceptor? | Interceptor modifying or monitoring queries | It observes database operations. |
| 5688 | What is SaveChanges interceptor? | Interceptor around save operations | It customizes persistence behavior. |
| 5689 | What is compiled query? | Precompiled EF Core query | It improves repeated query performance. |
| 5690 | What is raw SQL query? | Executing custom SQL through EF Core | It handles specialized queries. |
| 5691 | What is ExecuteSqlRaw()? | EF Core method executing raw SQL | It runs custom commands. |
| 5692 | What is FromSql()? | EF Core method querying with SQL | It maps SQL results to entities. |
| 5693 | What is bulk operation? | Processing many records in one operation | It improves large data handling. |
| 5694 | What is connection resiliency? | Ability to recover from temporary database failures | It improves reliability. |
| 5695 | What is database deadlock? | Situation where transactions block each other | It prevents progress. |
| 5696 | What is deadlock detection? | Process identifying database deadlocks | It enables recovery. |
| 5697 | What is query timeout? | Maximum allowed query execution duration | It controls resource usage. |
| 5698 | What is database locking? | Mechanism controlling concurrent access | It protects data consistency. |
| 5699 | What is row-level locking? | Locking individual database rows | It improves concurrency. |
| 5700 | What is table-level locking? | Locking an entire database table | It provides broader protection. |
| 5701 | What is API? | Application Programming Interface | It enables communication between software systems. |
| 5702 | What is Web API? | An API exposed over HTTP | It enables web-based communication. |
| 5703 | What is REST API? | An API following REST architectural principles | It uses HTTP resources and methods. |
| 5704 | What is REST? | Representational State Transfer architecture style | It designs scalable web services. |
| 5705 | What is REST resource? | A representation of data exposed through an API | It is accessed using URLs. |
| 5706 | What is REST endpoint? | A URL representing an API operation | It receives client requests. |
| 5707 | What is HTTP? | Hypertext Transfer Protocol | It enables web communication. |
| 5708 | What is HTTPS? | Secure HTTP using encryption | It protects data transmission. |
| 5709 | What is HTTP request? | A message sent from client to server | It requests an operation. |
| 5710 | What is HTTP response? | A message sent from server to client | It returns results. |
| 5711 | What is HTTP method? | An operation type in HTTP | It defines request intent. |
| 5712 | What is GET method? | HTTP method retrieving data | It should not modify resources. |
| 5713 | What is POST method? | HTTP method creating data | It submits new resources. |
| 5714 | What is PUT method? | HTTP method replacing data | It updates complete resources. |
| 5715 | What is PATCH method? | HTTP method partially updating data | It modifies specific fields. |
| 5716 | What is DELETE method? | HTTP method removing data | It deletes resources. |
| 5717 | What is HEAD method? | HTTP method returning headers without body | It checks resource metadata. |
| 5718 | What is OPTIONS method? | HTTP method describing supported operations | It supports API discovery. |
| 5719 | What is HTTP status code? | Numeric response indicator from server | It describes request outcome. |
| 5720 | What is 200 OK? | HTTP success response | It indicates successful processing. |
| 5721 | What is 201 Created? | HTTP response for successful creation | It indicates a new resource. |
| 5722 | What is 204 No Content? | HTTP response with no response body | It indicates successful empty response. |
| 5723 | What is 400 Bad Request? | HTTP error for invalid client input | It indicates request problems. |
| 5724 | What is 401 Unauthorized? | HTTP response requiring authentication | It indicates missing identity. |
| 5725 | What is 403 Forbidden? | HTTP response denying access | It indicates insufficient permissions. |
| 5726 | What is 404 Not Found? | HTTP response for missing resources | It indicates unavailable data. |
| 5727 | What is 409 Conflict? | HTTP response for resource conflicts | It indicates state conflicts. |
| 5728 | What is 500 Internal Server Error? | HTTP response for server failures | It indicates application errors. |
| 5729 | What is 502 Bad Gateway? | HTTP response from invalid upstream response | It indicates proxy issues. |
| 5730 | What is 503 Service Unavailable? | HTTP response when service cannot handle requests | It indicates temporary failure. |
| 5731 | What is content negotiation? | Selecting response format based on client request | It supports multiple formats. |
| 5732 | What is Accept header? | Header specifying desired response formats | It supports negotiation. |
| 5733 | What is Content-Type header? | Header describing request or response format | It identifies data format. |
| 5734 | What is MIME type? | Identifier describing data format | It defines content types. |
| 5735 | What is JSON? | JavaScript Object Notation data format | It is widely used in APIs. |
| 5736 | What is XML? | Extensible Markup Language format | It represents structured data. |
| 5737 | What is serialization? | Converting objects into transferable formats | It enables communication. |
| 5738 | What is deserialization? | Converting data into objects | It restores application models. |
| 5739 | What is System.Text.Json? | Built-in .NET JSON library | It handles JSON processing. |
| 5740 | What is JsonSerializer? | .NET class for JSON conversion | It serializes and deserializes objects. |
| 5741 | What is JSON option? | Configuration controlling JSON behavior | It customizes serialization. |
| 5742 | What is camelCase naming? | Naming convention using lowercase first words | It is common in JSON APIs. |
| 5743 | What is API versioning? | Managing different API versions | It supports backward compatibility. |
| 5744 | What is URL versioning? | API versioning through URL paths | It exposes version identifiers. |
| 5745 | What is header versioning? | API versioning through request headers | It keeps URLs clean. |
| 5746 | What is query string versioning? | API versioning using query parameters | It provides version selection. |
| 5747 | What is backward compatibility? | Ability to support older clients | It prevents breaking changes. |
| 5748 | What is breaking change? | Change that causes existing clients to fail | It requires migration. |
| 5749 | What is API contract? | Agreement between API provider and consumers | It defines communication rules. |
| 5750 | What is OpenAPI? | Standard description format for APIs | It enables documentation and tooling. |
| 5751 | What is Swagger? | A toolset for documenting and testing APIs | It uses OpenAPI specifications. |
| 5752 | What is Swagger UI? | A browser interface for exploring APIs | It enables interactive testing. |
| 5753 | What is Swashbuckle? | A .NET library generating Swagger documents | It integrates OpenAPI with ASP.NET Core. |
| 5754 | What is NSwag? | A .NET OpenAPI tooling library | It generates API clients and docs. |
| 5755 | What is API documentation? | Description of API usage and behavior | It helps consumers integrate. |
| 5756 | What is API client? | Software consuming an API | It sends requests and processes responses. |
| 5757 | What is typed API client? | Client generated or written with strong types | It improves reliability. |
| 5758 | What is HttpClient? | .NET class for sending HTTP requests | It communicates with web services. |
| 5759 | What is HttpClientFactory? | .NET service for creating HttpClient instances | It manages lifetime and configuration. |
| 5760 | What is IHttpClientFactory? | Interface for creating configured HttpClient objects | It improves HTTP client usage. |
| 5761 | What is named HttpClient? | HttpClient configured with a specific name | It supports multiple configurations. |
| 5762 | What is typed HttpClient? | HttpClient wrapped in a custom service class | It provides strong typing. |
| 5763 | What is delegating handler? | HTTP message handler processing requests and responses | It adds cross-cutting behavior. |
| 5764 | What is HttpMessageHandler? | Component handling HTTP communication | It processes HTTP messages. |
| 5765 | What is Polly? | A .NET resilience library | It provides retries and fault handling. |
| 5766 | What is retry policy? | A policy repeating failed operations | It handles transient failures. |
| 5767 | What is circuit breaker pattern? | Pattern stopping calls after repeated failures | It prevents cascading failures. |
| 5768 | What is timeout policy? | Policy limiting operation duration | It prevents long-running calls. |
| 5769 | What is fallback policy? | Policy providing alternative behavior after failure | It improves resilience. |
| 5770 | What is bulkhead pattern? | Pattern isolating resources between operations | It limits failure impact. |
| 5771 | What is rate limiting? | Controlling the number of requests allowed | It protects services. |
| 5772 | What is throttling? | Restricting resource usage by clients | It prevents overload. |
| 5773 | What is ASP.NET Core rate limiting middleware? | Middleware controlling incoming request rates | It protects APIs. |
| 5774 | What is fixed window limiter? | Rate limiter using fixed time intervals | It controls request counts. |
| 5775 | What is sliding window limiter? | Rate limiter using moving time periods | It provides smoother limits. |
| 5776 | What is token bucket limiter? | Rate limiter using refillable tokens | It allows controlled bursts. |
| 5777 | What is concurrency limiter? | Limiter restricting simultaneous requests | It controls active workloads. |
| 5778 | What is CORS? | Cross-Origin Resource Sharing | It controls browser cross-origin requests. |
| 5779 | What is same-origin policy? | Browser security rule restricting origins | It protects users. |
| 5780 | What is origin? | Combination of scheme, host, and port | It identifies web sources. |
| 5781 | What is CORS policy? | Rules defining allowed cross-origin access | It controls API exposure. |
| 5782 | What is preflight request? | Browser OPTIONS request before certain calls | It checks permissions. |
| 5783 | What is Access-Control-Allow-Origin header? | Header specifying allowed origins | It enables CORS access. |
| 5784 | What is authentication? | Process verifying user identity | It confirms who someone is. |
| 5785 | What is authorization? | Process checking permissions | It controls access. |
| 5786 | What is identity? | Information representing a user or application | It describes who is making requests. |
| 5787 | What is claim? | A statement about an identity | It provides user information. |
| 5788 | What is claims-based authentication? | Authentication using identity claims | It enables flexible authorization. |
| 5789 | What is principal? | Object representing an authenticated identity | It contains claims. |
| 5790 | What is IPrincipal? | .NET abstraction representing an identity | It supports authorization checks. |
| 5791 | What is Identity? | ASP.NET Core authentication and user management framework | It manages application users. |
| 5792 | What is UserManager? | ASP.NET Core Identity service managing users | It handles user operations. |
| 5793 | What is SignInManager? | ASP.NET Core Identity service handling authentication | It manages sign-in processes. |
| 5794 | What is RoleManager? | Service managing user roles | It handles role operations. |
| 5795 | What is role-based authorization? | Authorization based on assigned roles | It controls access by groups. |
| 5796 | What is policy-based authorization? | Authorization based on custom policies | It provides flexible rules. |
| 5797 | What is authorization requirement? | A condition that must be satisfied | It defines access rules. |
| 5798 | What is authorization handler? | Component evaluating requirements | It decides authorization results. |
| 5799 | What is JWT? | JSON Web Token authentication format | It carries signed identity information. |
| 5800 | What is bearer token? | Token sent in Authorization header | It authenticates API requests. |
| 5801 | What is JWT structure? | A token containing header, payload, and signature | It carries verifiable claims. |
| 5802 | What is JWT header? | Part of JWT containing token metadata | It describes signing information. |
| 5803 | What is JWT payload? | Part of JWT containing claims | It stores identity data. |
| 5804 | What is JWT signature? | Cryptographic part validating token integrity | It prevents tampering. |
| 5805 | What is access token? | Token used to access protected resources | It grants temporary access. |
| 5806 | What is refresh token? | Token used to obtain new access tokens | It extends authentication sessions. |
| 5807 | What is token expiration? | Time limit after which a token becomes invalid | It improves security. |
| 5808 | What is token validation? | Process checking token authenticity and claims | It verifies requests. |
| 5809 | What is issuer in JWT? | Entity that created the token | It identifies token source. |
| 5810 | What is audience in JWT? | Intended recipient of the token | It restricts token usage. |
| 5811 | What is signing key? | Secret or certificate used to sign tokens | It protects token integrity. |
| 5812 | What is symmetric signing? | JWT signing using the same secret key | It uses shared secrets. |
| 5813 | What is asymmetric signing? | JWT signing using private and public keys | It improves key distribution. |
| 5814 | What is OAuth 2.0? | Authorization framework for delegated access | It enables secure resource access. |
| 5815 | What is OpenID Connect? | Authentication layer built on OAuth 2.0 | It provides identity information. |
| 5816 | What is authorization code flow? | OAuth flow using authorization codes | It is common for web apps. |
| 5817 | What is client credentials flow? | OAuth flow for machine-to-machine authentication | It uses application identity. |
| 5818 | What is implicit flow? | Older OAuth flow returning tokens directly | It is generally replaced. |
| 5819 | What is PKCE? | Proof Key for Code Exchange | It protects authorization code flow. |
| 5820 | What is identity provider? | System managing user identities | It authenticates users. |
| 5821 | What is resource server? | Server hosting protected resources | It validates access tokens. |
| 5822 | What is client application? | Application requesting access to resources | It uses authentication flows. |
| 5823 | What is single sign-on? | Authentication allowing access to multiple systems | It improves user experience. |
| 5824 | What is SSO? | Single Sign-On abbreviation | It centralizes authentication. |
| 5825 | What is multi-factor authentication? | Authentication using multiple verification methods | It increases security. |
| 5826 | What is MFA? | Multi-Factor Authentication abbreviation | It adds authentication layers. |
| 5827 | What is password hashing? | Converting passwords into irreversible values | It protects stored passwords. |
| 5828 | What is password salting? | Adding random data before hashing | It prevents rainbow table attacks. |
| 5829 | What is encryption? | Transforming data into unreadable form | It protects confidentiality. |
| 5830 | What is decryption? | Converting encrypted data back | It restores original information. |
| 5831 | What is symmetric encryption? | Encryption using one shared key | It is fast for large data. |
| 5832 | What is asymmetric encryption? | Encryption using public and private keys | It supports secure key exchange. |
| 5833 | What is TLS? | Transport Layer Security protocol | It secures network communication. |
| 5834 | What is SSL certificate? | Digital certificate used for secure connections | It verifies website identity. |
| 5835 | What is certificate authority? | Trusted organization issuing certificates | It establishes trust. |
| 5836 | What is HTTPS certificate validation? | Process verifying server certificates | It prevents impersonation. |
| 5837 | What is security header? | HTTP header improving browser security | It reduces attack risks. |
| 5838 | What is HSTS? | HTTP Strict Transport Security | It forces HTTPS usage. |
| 5839 | What is Content Security Policy? | Browser security policy controlling resources | It reduces XSS risks. |
| 5840 | What is X-Frame-Options? | Header controlling iframe embedding | It prevents clickjacking. |
| 5841 | What is XSS? | Cross-Site Scripting attack | It injects malicious scripts. |
| 5842 | What is CSRF? | Cross-Site Request Forgery attack | It tricks users into unwanted actions. |
| 5843 | What is clickjacking? | Attack hiding malicious actions behind UI elements | It abuses user interaction. |
| 5844 | What is SQL injection prevention? | Techniques preventing malicious SQL input | It protects databases. |
| 5845 | What is input validation? | Checking user input before processing | It improves security. |
| 5846 | What is output encoding? | Escaping output before displaying | It prevents injection attacks. |
| 5847 | What is security by design? | Building security into architecture from the beginning | It reduces vulnerabilities. |
| 5848 | What is least privilege principle? | Giving only required permissions | It limits damage. |
| 5849 | What is defense in depth? | Using multiple security layers | It improves protection. |
| 5850 | What is secure coding? | Writing software with security considerations | It reduces vulnerabilities. |
| 5851 | What is OWASP? | Open Web Application Security Project | It provides web security guidance. |
| 5852 | What is OWASP Top 10? | List of major web application security risks | It highlights common vulnerabilities. |
| 5853 | What is vulnerability? | A weakness that can be exploited | It creates security risks. |
| 5854 | What is threat? | A potential cause of harm to a system | It represents possible attacks. |
| 5855 | What is risk? | Combination of probability and impact of a threat | It measures security exposure. |
| 5856 | What is attack surface? | All possible points where a system can be attacked | It defines exposure. |
| 5857 | What is penetration testing? | Security testing by simulating attacks | It discovers vulnerabilities. |
| 5858 | What is security audit? | Review of security controls and practices | It verifies protection. |
| 5859 | What is vulnerability scanning? | Automated detection of security weaknesses | It identifies issues. |
| 5860 | What is static application security testing? | Security analysis of source code | It finds coding vulnerabilities. |
| 5861 | What is dynamic application security testing? | Security testing of running applications | It finds runtime issues. |
| 5862 | What is SAST? | Static Application Security Testing | It analyzes code without execution. |
| 5863 | What is DAST? | Dynamic Application Security Testing | It tests running applications. |
| 5864 | What is dependency scanning? | Checking third-party libraries for vulnerabilities | It improves supply chain security. |
| 5865 | What is secure dependency management? | Managing libraries with security awareness | It reduces risks. |
| 5866 | What is secrets management? | Secure handling of passwords, keys, and tokens | It protects sensitive information. |
| 5867 | What is secret rotation? | Periodically replacing secrets | It limits exposure. |
| 5868 | What is API key? | A credential identifying an application | It controls API access. |
| 5869 | What is API key management? | Creating and protecting API keys | It secures integrations. |
| 5870 | What is authentication middleware? | Middleware handling user authentication | It processes identity information. |
| 5871 | What is authorization middleware? | Middleware enforcing access policies | It protects resources. |
| 5872 | What is UseAuthentication()? | ASP.NET Core middleware enabling authentication | It sets the user identity. |
| 5873 | What is UseAuthorization()? | ASP.NET Core middleware enabling authorization | It checks permissions. |
| 5874 | What is AuthenticationScheme? | A named authentication mechanism | It selects authentication handlers. |
| 5875 | What is authentication handler? | Component implementing authentication logic | It validates credentials. |
| 5876 | What is cookie authentication? | Authentication using browser cookies | It is common for web apps. |
| 5877 | What is JWT bearer authentication? | Authentication using JWT access tokens | It is common for APIs. |
| 5878 | What is authorization policy? | A set of authorization requirements | It defines access rules. |
| 5879 | What is fallback authorization policy? | Default policy applied when no policy is specified | It protects endpoints by default. |
| 5880 | What is resource-based authorization? | Authorization based on a specific resource | It checks ownership or access. |
| 5881 | What is custom authorization handler? | User-created authorization logic | It supports complex rules. |
| 5882 | What is identity cookie? | Cookie storing authentication information | It maintains user sessions. |
| 5883 | What is login flow? | Process allowing users to authenticate | It establishes identity. |
| 5884 | What is logout flow? | Process ending authentication session | It removes access. |
| 5885 | What is account lockout? | Temporarily blocking accounts after failures | It prevents brute force attacks. |
| 5886 | What is brute force attack? | Attack trying many credential combinations | It targets authentication. |
| 5887 | What is credential stuffing? | Using stolen credentials across systems | It exploits password reuse. |
| 5888 | What is phishing? | Social engineering attack stealing information | It targets users. |
| 5889 | What is social engineering? | Manipulating people to reveal information | It exploits human behavior. |
| 5890 | What is malware? | Malicious software designed to cause harm | It compromises systems. |
| 5891 | What is ransomware? | Malware encrypting data for payment | It blocks access. |
| 5892 | What is spyware? | Malware collecting information secretly | It invades privacy. |
| 5893 | What is denial of service attack? | Attack making services unavailable | It overloads systems. |
| 5894 | What is DDoS? | Distributed Denial of Service attack | It uses many sources. |
| 5895 | What is WAF? | Web Application Firewall | It filters malicious web traffic. |
| 5896 | What is firewall? | Security system controlling network traffic | It blocks unauthorized access. |
| 5897 | What is network segmentation? | Dividing networks into isolated sections | It limits attack spread. |
| 5898 | What is zero trust security? | Security model requiring verification everywhere | It assumes no implicit trust. |
| 5899 | What is security monitoring? | Continuous observation of security events | It detects threats. |
| 5900 | What is incident response? | Process for handling security incidents | It reduces damage. |
| 5901 | What is DevOps? | A culture combining development and operations | It improves software delivery. |
| 5902 | What is DevSecOps? | DevOps with security integrated throughout the lifecycle | It builds security into delivery. |
| 5903 | What is Agile? | An iterative software development approach | It delivers value incrementally. |
| 5904 | What is Scrum? | An Agile framework using sprints and roles | It organizes development work. |
| 5905 | What is Sprint? | A fixed development iteration | It delivers planned work. |
| 5906 | What is Product Backlog? | Ordered list of required features and tasks | It guides development. |
| 5907 | What is Sprint Backlog? | Work selected for a sprint | It defines sprint activities. |
| 5908 | What is User Story? | Description of a feature from user perspective | It captures requirements. |
| 5909 | What is Acceptance Criteria? | Conditions defining feature completion | It validates requirements. |
| 5910 | What is Definition of Done? | Agreement defining completed work | It ensures quality. |
| 5911 | What is Scrum Master? | Person facilitating Scrum process | It removes impediments. |
| 5912 | What is Product Owner? | Person responsible for product value | It manages priorities. |
| 5913 | What is Daily Standup? | Short daily Scrum meeting | It synchronizes team progress. |
| 5914 | What is Sprint Review? | Meeting demonstrating sprint results | It collects feedback. |
| 5915 | What is Sprint Retrospective? | Meeting reviewing team improvements | It improves processes. |
| 5916 | What is Kanban? | Visual workflow management method | It manages work continuously. |
| 5917 | What is Continuous Improvement? | Ongoing process optimization | It improves efficiency. |
| 5918 | What is Software Development Life Cycle? | Process of creating and maintaining software | It structures development. |
| 5919 | What is SDLC? | Software Development Life Cycle abbreviation | It defines development phases. |
| 5920 | What is requirement analysis? | Process understanding software needs | It defines expected behavior. |
| 5921 | What is design phase? | Phase creating system architecture | It plans implementation. |
| 5922 | What is implementation phase? | Phase writing application code | It builds the solution. |
| 5923 | What is testing phase? | Phase verifying software quality | It finds defects. |
| 5924 | What is deployment phase? | Phase releasing software to users | It delivers the product. |
| 5925 | What is maintenance phase? | Phase supporting and improving software | It handles changes. |
| 5926 | What is code review? | Examination of source code by developers | It improves quality. |
| 5927 | What is pull request? | Request to merge code changes | It enables review. |
| 5928 | What is merge? | Combining code changes from branches | It integrates work. |
| 5929 | What is branch? | Separate line of development in version control | It isolates changes. |
| 5930 | What is Git? | Distributed version control system | It manages source code. |
| 5931 | What is Git repository? | Storage location for Git-managed files | It tracks changes. |
| 5932 | What is Git commit? | Saved snapshot of code changes | It records history. |
| 5933 | What is Git push? | Uploading commits to remote repository | It shares changes. |
| 5934 | What is Git pull? | Downloading and merging remote changes | It updates local code. |
| 5935 | What is Git clone? | Creating a local copy of a repository | It downloads source code. |
| 5936 | What is Git merge conflict? | Situation where Git cannot automatically combine changes | It requires manual resolution. |
| 5937 | What is Git rebase? | Moving commits onto another branch base | It creates cleaner history. |
| 5938 | What is Git stash? | Temporary storage for uncommitted changes | It preserves work. |
| 5939 | What is Git tag? | Label identifying a specific commit | It marks releases. |
| 5940 | What is semantic release? | Release process based on version semantics | It communicates changes. |
| 5941 | What is trunk-based development? | Development using a main shared branch | It supports continuous delivery. |
| 5942 | What is GitFlow? | Branching model for development workflows | It structures releases. |
| 5943 | What is feature branch? | Branch created for a specific feature | It isolates development. |
| 5944 | What is hotfix branch? | Branch for urgent production fixes | It enables quick patches. |
| 5945 | What is release branch? | Branch preparing a software release | It stabilizes versions. |
| 5946 | What is code quality? | Measure of maintainability and reliability of code | It improves software health. |
| 5947 | What is static code analysis? | Automated code quality inspection | It finds issues early. |
| 5948 | What is SonarQube? | Code quality and security analysis platform | It detects code problems. |
| 5949 | What is code smell? | Design issue indicating possible problems | It suggests improvement areas. |
| 5950 | What is technical debt? | Future cost caused by quick or poor design choices | It affects maintainability. |
| 5951 | What is refactoring? | Improving code structure without changing behavior | It reduces complexity. |
| 5952 | What is clean code? | Code that is readable, maintainable, and understandable | It improves long-term quality. |
| 5953 | What is code readability? | Ease of understanding source code | It improves collaboration. |
| 5954 | What is coding standard? | Rules and conventions for writing code | It ensures consistency. |
| 5955 | What is naming convention? | Rules for naming variables, methods, and classes | It improves clarity. |
| 5956 | What is documentation? | Information explaining software behavior and usage | It helps maintenance. |
| 5957 | What is XML documentation? | Documentation comments in .NET source code | It generates API documentation. |
| 5958 | What is IntelliSense? | Code completion feature in IDEs | It improves developer productivity. |
| 5959 | What is Visual Studio? | Integrated development environment for .NET development | It provides coding tools. |
| 5960 | What is Visual Studio Code? | Lightweight cross-platform code editor | It supports many technologies. |
| 5961 | What is IDE? | Integrated Development Environment | It combines development tools. |
| 5962 | What is debugger? | Tool for finding and fixing code issues | It allows step execution. |
| 5963 | What is breakpoint? | Marker where debugger pauses execution | It helps inspect code. |
| 5964 | What is step over? | Debugging command executing current line | It moves through code. |
| 5965 | What is step into? | Debugging command entering called methods | It examines internal logic. |
| 5966 | What is step out? | Debugging command leaving current method | It returns to caller. |
| 5967 | What is watch window? | Debugging tool displaying variable values | It monitors expressions. |
| 5968 | What is immediate window? | Debugging tool executing expressions | It tests code during debugging. |
| 5969 | What is exception? | Runtime error condition | It interrupts normal execution. |
| 5970 | What is try-catch block? | Structure handling exceptions | It manages errors. |
| 5971 | What is finally block? | Block always executed after try-catch | It performs cleanup. |
| 5972 | What is custom exception? | User-defined exception type | It represents specific errors. |
| 5973 | What is global exception handler? | Centralized error handling mechanism | It avoids repeated handling code. |
| 5974 | What is logging framework? | System for recording application events | It supports monitoring. |
| 5975 | What is Serilog? | Structured logging library for .NET | It records structured events. |
| 5976 | What is NLog? | Logging framework for .NET applications | It manages log output. |
| 5977 | What is Microsoft.Extensions.Logging? | Built-in .NET logging abstraction | It provides common logging APIs. |
| 5978 | What is structured logging? | Logging data as structured properties | It improves searching and analysis. |
| 5979 | What is log level? | Importance category of log messages | It controls verbosity. |
| 5980 | What is Trace log level? | Detailed diagnostic logging level | It helps deep troubleshooting. |
| 5981 | What is Debug log level? | Logging for development diagnostics | It assists debugging. |
| 5982 | What is Information log level? | Normal operational logging level | It records application events. |
| 5983 | What is Warning log level? | Logging potential problems | It indicates attention needed. |
| 5984 | What is Error log level? | Logging failures and exceptions | It indicates problems. |
| 5985 | What is Critical log level? | Logging severe application failures | It indicates major issues. |
| 5986 | What is correlation ID? | Identifier tracking a request across services | It supports troubleshooting. |
| 5987 | What is distributed tracing? | Tracking requests across distributed systems | It identifies performance issues. |
| 5988 | What is OpenTelemetry? | Observability framework for traces, metrics, and logs | It standardizes telemetry. |
| 5989 | What is telemetry? | Data collected about application behavior | It supports monitoring. |
| 5990 | What is metric? | Numerical measurement of system behavior | It tracks performance. |
| 5991 | What is trace? | Record of request execution path | It shows system flow. |
| 5992 | What is span? | Individual operation within a trace | It represents work units. |
| 5993 | What is observability? | Ability to understand system behavior from outputs | It improves operations. |
| 5994 | What is monitoring? | Continuous observation of system health | It detects issues. |
| 5995 | What is alerting? | Sending notifications based on conditions | It enables quick response. |
| 5996 | What is dashboard? | Visual display of system information | It summarizes health data. |
| 5997 | What is performance testing? | Testing system speed and scalability | It measures capacity. |
| 5998 | What is load testing? | Testing application under expected traffic | It validates performance. |
| 5999 | What is stress testing? | Testing beyond normal capacity | It finds breaking points. |
| 6000 | What is scalability testing? | Testing ability to handle increased load | It evaluates growth capability. |
| 6001 | What is unit testing? | Testing individual components in isolation | It verifies small pieces of code. |
| 6002 | What is integration testing? | Testing interaction between multiple components | It verifies system collaboration. |
| 6003 | What is functional testing? | Testing software features against requirements | It validates behavior. |
| 6004 | What is regression testing? | Testing to ensure existing features still work | It prevents unintended changes. |
| 6005 | What is smoke testing? | Basic testing to verify critical functionality | It checks build stability. |
| 6006 | What is sanity testing? | Quick testing of specific changes | It confirms expected fixes. |
| 6007 | What is acceptance testing? | Testing performed to verify business requirements | It confirms user expectations. |
| 6008 | What is UAT? | User Acceptance Testing | It validates software with users. |
| 6009 | What is test case? | Documented set of conditions and steps for testing | It verifies expected behavior. |
| 6010 | What is test scenario? | High-level description of what should be tested | It defines test coverage. |
| 6011 | What is test suite? | Collection of related test cases | It organizes testing. |
| 6012 | What is test fixture? | Common setup required for tests | It prepares test environments. |
| 6013 | What is assertion? | Statement verifying expected results | It determines test success. |
| 6014 | What is mocking? | Creating fake objects for testing | It isolates dependencies. |
| 6015 | What is mock object? | Fake implementation used during testing | It simulates dependencies. |
| 6016 | What is stub? | Simplified replacement providing predefined responses | It supports testing. |
| 6017 | What is fake object? | Working but simplified implementation | It replaces real dependencies. |
| 6018 | What is test double? | General term for fake testing objects | It replaces real collaborators. |
| 6019 | What is dependency isolation? | Testing without relying on external systems | It improves reliability. |
| 6020 | What is xUnit? | .NET testing framework | It creates automated tests. |
| 6021 | What is NUnit? | Unit testing framework for .NET | It supports automated testing. |
| 6022 | What is MSTest? | Microsoft testing framework | It runs .NET tests. |
| 6023 | What is Moq? | Mocking library for .NET | It creates mock objects. |
| 6024 | What is FluentAssertions? | Assertion library for .NET tests | It improves test readability. |
| 6025 | What is code coverage? | Percentage of code executed by tests | It measures test completeness. |
| 6026 | What is branch coverage? | Coverage measuring executed decision paths | It evaluates logic testing. |
| 6027 | What is line coverage? | Coverage measuring executed code lines | It measures execution. |
| 6028 | What is mutation testing? | Testing quality by introducing code changes | It evaluates test effectiveness. |
| 6029 | What is test-driven development? | Development approach writing tests before code | It guides implementation. |
| 6030 | What is TDD? | Test-Driven Development abbreviation | It emphasizes automated tests. |
| 6031 | What is behavior-driven development? | Development approach using business-readable tests | It improves collaboration. |
| 6032 | What is BDD? | Behavior-Driven Development abbreviation | It focuses on behavior. |
| 6033 | What is Given-When-Then? | BDD scenario structure | It describes expected behavior. |
| 6034 | What is acceptance test-driven development? | Approach creating acceptance tests before development | It aligns implementation with requirements. |
| 6035 | What is test automation? | Using tools to execute tests automatically | It improves efficiency. |
| 6036 | What is Selenium? | Browser automation testing framework | It tests web applications. |
| 6037 | What is Playwright? | Modern browser automation framework | It supports end-to-end testing. |
| 6038 | What is Cypress? | Frontend testing framework | It tests web applications. |
| 6039 | What is API testing? | Testing application programming interfaces | It validates service behavior. |
| 6040 | What is Postman? | Tool for testing and exploring APIs | It sends HTTP requests. |
| 6041 | What is REST client? | Tool or library consuming REST APIs | It communicates with services. |
| 6042 | What is end-to-end testing? | Testing complete user workflows | It validates the whole system. |
| 6043 | What is UI testing? | Testing user interface behavior | It verifies user interactions. |
| 6044 | What is exploratory testing? | Testing without predefined scripts | It discovers unexpected issues. |
| 6045 | What is manual testing? | Human execution of test cases | It validates software behavior. |
| 6046 | What is automated testing pyramid? | Model describing testing levels | It guides test strategy. |
| 6047 | What is test pyramid? | Model prioritizing unit tests over UI tests | It balances testing effort. |
| 6048 | What is quality assurance? | Process ensuring software quality | It prevents defects. |
| 6049 | What is quality control? | Process identifying defects in products | It verifies output quality. |
| 6050 | What is defect? | An error causing incorrect software behavior | It requires fixing. |
| 6051 | What is bug? | A defect or error in software behavior | It causes unexpected results. |
| 6052 | What is issue? | A reported problem requiring attention | It tracks work items. |
| 6053 | What is defect lifecycle? | Process of managing defects from discovery to closure | It controls bug resolution. |
| 6054 | What is bug tracking system? | Tool for managing software defects | It organizes fixes. |
| 6055 | What is Jira? | Issue and project management platform | It tracks development work. |
| 6056 | What is Azure Boards? | Work tracking service in Azure DevOps | It manages tasks and bugs. |
| 6057 | What is work item? | Trackable unit of work | It represents tasks or issues. |
| 6058 | What is epic? | Large body of work containing features | It organizes major goals. |
| 6059 | What is feature? | Product capability delivering value | It groups related work. |
| 6060 | What is task? | Small unit of work | It represents implementation steps. |
| 6061 | What is bug work item? | Work item representing a defect | It tracks corrections. |
| 6062 | What is backlog refinement? | Process of reviewing and preparing backlog items | It improves planning. |
| 6063 | What is estimation? | Predicting effort required for work | It supports planning. |
| 6064 | What is story point? | Relative effort measurement unit | It estimates complexity. |
| 6065 | What is planning poker? | Team estimation technique | It encourages discussion. |
| 6066 | What is velocity? | Amount of work completed in a sprint | It helps forecasting. |
| 6067 | What is burndown chart? | Chart showing remaining work over time | It tracks sprint progress. |
| 6068 | What is burnup chart? | Chart showing completed work over time | It tracks progress growth. |
| 6069 | What is milestone? | Significant project checkpoint | It marks progress. |
| 6070 | What is roadmap? | High-level plan for future product development | It communicates direction. |
| 6071 | What is release management? | Process managing software releases | It controls delivery. |
| 6072 | What is release version? | Identifiable version of software delivered | It tracks changes. |
| 6073 | What is patch release? | Release containing bug fixes | It corrects issues. |
| 6074 | What is minor release? | Release adding backward-compatible features | It extends functionality. |
| 6075 | What is major release? | Release introducing significant changes | It may break compatibility. |
| 6076 | What is changelog? | Document listing software changes | It informs users. |
| 6077 | What is release notes? | Communication describing a release | It summarizes updates. |
| 6078 | What is deployment strategy? | Method used to release software | It controls rollout. |
| 6079 | What is blue-green deployment? | Deployment strategy using two environments | It enables quick switching. |
| 6080 | What is canary deployment? | Deployment releasing changes gradually | It reduces risk. |
| 6081 | What is rolling deployment? | Deployment replacing instances gradually | It avoids downtime. |
| 6082 | What is feature flag? | Configuration controlling feature availability | It enables controlled releases. |
| 6083 | What is dark launch? | Releasing functionality without user exposure | It enables testing. |
| 6084 | What is A/B testing? | Comparing two versions with users | It measures impact. |
| 6085 | What is environment? | Context where software runs | It defines configuration. |
| 6086 | What is development environment? | Environment used by developers | It supports coding. |
| 6087 | What is testing environment? | Environment used for validation | It supports testing. |
| 6088 | What is staging environment? | Environment similar to production | It validates releases. |
| 6089 | What is production environment? | Live environment used by customers | It serves real users. |
| 6090 | What is configuration management? | Managing application settings and environments | It ensures consistency. |
| 6091 | What is infrastructure as code? | Managing infrastructure through code | It automates provisioning. |
| 6092 | What is IaC? | Infrastructure as Code abbreviation | It defines infrastructure declaratively. |
| 6093 | What is Terraform? | Infrastructure as code tool | It provisions cloud resources. |
| 6094 | What is ARM template? | Azure Resource Manager deployment template | It defines Azure infrastructure. |
| 6095 | What is Bicep? | Azure infrastructure-as-code language | It simplifies ARM templates. |
| 6096 | What is configuration file? | File containing application settings | It controls behavior. |
| 6097 | What is environment variable? | External configuration value | It separates settings from code. |
| 6098 | What is secret configuration? | Protected storage for sensitive settings | It secures credentials. |
| 6099 | What is twelve-factor app? | Methodology for building cloud applications | It improves portability. |
| 6100 | What is immutable infrastructure? | Infrastructure replaced rather than modified | It improves consistency. |
| 6101 | What is CI? | Continuous Integration | It automatically builds and tests code changes. |
| 6102 | What is CD? | Continuous Delivery or Continuous Deployment | It automates software release processes. |
| 6103 | What is Continuous Integration? | Practice of frequently merging code changes | It detects issues early. |
| 6104 | What is Continuous Delivery? | Practice of keeping software ready for release | It improves deployment reliability. |
| 6105 | What is Continuous Deployment? | Automatically releasing validated changes to production | It enables rapid delivery. |
| 6106 | What is CI/CD pipeline? | Automated workflow for building, testing, and deploying software | It streamlines delivery. |
| 6107 | What is build pipeline? | Automated process compiling and validating code | It creates deployable artifacts. |
| 6108 | What is release pipeline? | Automated process deploying applications | It manages releases. |
| 6109 | What is build agent? | Machine executing pipeline tasks | It performs automation jobs. |
| 6110 | What is pipeline runner? | Service executing CI/CD workflows | It runs automation steps. |
| 6111 | What is artifact? | Output produced by a build process | It is used for deployment. |
| 6112 | What is artifact repository? | Storage location for build outputs | It manages packages and binaries. |
| 6113 | What is NuGet package? | Package format used in .NET ecosystem | It distributes reusable libraries. |
| 6114 | What is NuGet? | .NET package management system | It manages dependencies. |
| 6115 | What is package restore? | Downloading required dependencies | It prepares builds. |
| 6116 | What is package versioning? | Managing dependency versions | It controls compatibility. |
| 6117 | What is semantic versioning? | Version format using major.minor.patch | It communicates change impact. |
| 6118 | What is dependency management? | Managing external libraries and components | It controls software dependencies. |
| 6119 | What is package lock file? | File recording exact dependency versions | It ensures repeatable builds. |
| 6120 | What is Docker? | Platform for creating and running containers | It packages applications. |
| 6121 | What is container? | Isolated environment running an application | It improves portability. |
| 6122 | What is container image? | Immutable package containing application and dependencies | It creates containers. |
| 6123 | What is Dockerfile? | File describing how to build an image | It automates image creation. |
| 6124 | What is Docker image layer? | Intermediate filesystem layer in an image | It improves build efficiency. |
| 6125 | What is Docker container registry? | Repository storing container images | It distributes images. |
| 6126 | What is Docker Hub? | Public container image registry | It hosts images. |
| 6127 | What is container orchestration? | Managing multiple containers automatically | It handles scaling and availability. |
| 6128 | What is Kubernetes? | Container orchestration platform | It manages container workloads. |
| 6129 | What is Kubernetes cluster? | Group of machines running Kubernetes workloads | It hosts applications. |
| 6130 | What is Kubernetes node? | Machine participating in a cluster | It runs workloads. |
| 6131 | What is Kubernetes pod? | Smallest deployable Kubernetes unit | It contains containers. |
| 6132 | What is Kubernetes deployment? | Resource managing application replicas | It maintains desired state. |
| 6133 | What is Kubernetes service? | Network abstraction exposing pods | It enables communication. |
| 6134 | What is Kubernetes ingress? | Resource managing external HTTP access | It routes traffic. |
| 6135 | What is Kubernetes namespace? | Logical cluster partition | It organizes resources. |
| 6136 | What is Kubernetes config map? | Resource storing non-sensitive configuration | It externalizes settings. |
| 6137 | What is Kubernetes secret? | Resource storing sensitive configuration | It protects credentials. |
| 6138 | What is container scaling? | Increasing or decreasing container instances | It manages workload demand. |
| 6139 | What is horizontal scaling? | Adding more application instances | It increases capacity. |
| 6140 | What is vertical scaling? | Increasing resources of an existing instance | It improves individual capacity. |
| 6141 | What is auto scaling? | Automatically adjusting resources based on demand | It optimizes availability. |
| 6142 | What is cloud computing? | Delivery of computing resources over networks | It provides flexible infrastructure. |
| 6143 | What is IaaS? | Infrastructure as a Service | It provides virtual infrastructure. |
| 6144 | What is PaaS? | Platform as a Service | It provides application platforms. |
| 6145 | What is SaaS? | Software as a Service | It provides hosted applications. |
| 6146 | What is FaaS? | Function as a Service | It runs serverless functions. |
| 6147 | What is serverless computing? | Cloud execution model without server management | It focuses on application logic. |
| 6148 | What is cloud region? | Geographic area containing cloud resources | It provides location options. |
| 6149 | What is availability zone? | Isolated data center location within a region | It improves resilience. |
| 6150 | What is cloud scalability? | Ability to increase resources on demand | It supports growth. |
| 6151 | What is Microsoft Azure? | Cloud computing platform from Microsoft | It provides infrastructure and services. |
| 6152 | What is Azure App Service? | Platform for hosting web applications | It simplifies deployment. |
| 6153 | What is Azure Function? | Serverless compute service | It runs event-driven code. |
| 6154 | What is Azure Storage? | Cloud storage service from Azure | It stores files and data. |
| 6155 | What is Azure Blob Storage? | Object storage service | It stores unstructured data. |
| 6156 | What is Azure Queue Storage? | Message queue storage service | It supports asynchronous processing. |
| 6157 | What is Azure Table Storage? | NoSQL key-value storage service | It stores structured non-relational data. |
| 6158 | What is Azure Files? | Managed cloud file share service | It provides shared storage. |
| 6159 | What is Azure SQL Database? | Managed relational database service | It provides SQL Server capabilities. |
| 6160 | What is Azure Cosmos DB? | Globally distributed NoSQL database | It provides low-latency access. |
| 6161 | What is Azure Service Bus? | Enterprise messaging service | It enables reliable communication. |
| 6162 | What is Azure Event Grid? | Event routing service | It distributes events. |
| 6163 | What is Azure Event Hubs? | High-throughput event ingestion service | It processes large event streams. |
| 6164 | What is Azure Key Vault? | Secure secrets and key management service | It protects sensitive information. |
| 6165 | What is Azure Identity? | Authentication library for Azure resources | It manages cloud authentication. |
| 6166 | What is Managed Identity? | Azure identity without stored credentials | It improves security. |
| 6167 | What is Azure Virtual Machine? | Cloud-hosted virtual server | It provides compute resources. |
| 6168 | What is Azure Kubernetes Service? | Managed Kubernetes service | It runs container workloads. |
| 6169 | What is AKS? | Azure Kubernetes Service abbreviation | It manages Kubernetes clusters. |
| 6170 | What is Azure Container Registry? | Private registry for container images | It stores Docker images. |
| 6171 | What is Azure DevOps? | Microsoft platform for development lifecycle management | It supports CI/CD and collaboration. |
| 6172 | What is Azure Pipeline? | CI/CD automation service | It builds and deploys applications. |
| 6173 | What is Azure Repository? | Source control repository in Azure DevOps | It stores code. |
| 6174 | What is Azure Artifacts? | Package management service | It hosts dependencies. |
| 6175 | What is Azure Monitor? | Monitoring service for Azure resources | It collects telemetry. |
| 6176 | What is Application Insights? | Application performance monitoring service | It tracks application behavior. |
| 6177 | What is Log Analytics? | Service analyzing logs and telemetry | It supports troubleshooting. |
| 6178 | What is Azure Application Gateway? | Web traffic routing service | It provides application-level load balancing. |
| 6179 | What is Azure Load Balancer? | Network load distribution service | It balances traffic. |
| 6180 | What is Azure Front Door? | Global web application delivery service | It improves performance and availability. |
| 6181 | What is Azure CDN? | Content Delivery Network service | It caches content globally. |
| 6182 | What is Azure DNS? | Domain name hosting service | It manages DNS records. |
| 6183 | What is Azure Virtual Network? | Private network service in Azure | It connects cloud resources securely. |
| 6184 | What is subnet? | Logical network segment | It organizes network resources. |
| 6185 | What is Network Security Group? | Azure network traffic filtering mechanism | It controls access rules. |
| 6186 | What is NSG? | Network Security Group abbreviation | It filters network traffic. |
| 6187 | What is private endpoint? | Private network connection to Azure services | It avoids public exposure. |
| 6188 | What is service endpoint? | Network connection securing Azure service access | It extends virtual networks. |
| 6189 | What is Azure Firewall? | Managed cloud network firewall | It protects network traffic. |
| 6190 | What is Azure Bastion? | Secure remote access service for virtual machines | It avoids public IP exposure. |
| 6191 | What is Azure Policy? | Governance service enforcing rules | It manages compliance. |
| 6192 | What is Azure RBAC? | Role-based access control system | It manages permissions. |
| 6193 | What is subscription in Azure? | Billing and resource management boundary | It organizes resources. |
| 6194 | What is resource group? | Container for related Azure resources | It manages lifecycle together. |
| 6195 | What is Azure tenant? | Dedicated instance of Microsoft Entra ID | It represents an organization. |
| 6196 | What is Microsoft Entra ID? | Cloud identity and access management service | It authenticates users and applications. |
| 6197 | What is Azure AD? | Former name of Microsoft Entra ID | It provides identity services. |
| 6198 | What is Azure portal? | Web interface for managing Azure resources | It provides cloud management. |
| 6199 | What is Azure CLI? | Command-line tool for Azure management | It automates cloud operations. |
| 6200 | What is Azure PowerShell? | PowerShell module for Azure management | It manages Azure resources through scripts. |
| 6201 | What is cloud deployment model? | Method of deploying cloud resources | It defines infrastructure ownership. |
| 6202 | What is public cloud? | Cloud infrastructure shared among customers | It provides scalable services. |
| 6203 | What is private cloud? | Cloud infrastructure dedicated to one organization | It provides greater control. |
| 6204 | What is hybrid cloud? | Combination of public and private clouds | It provides flexibility. |
| 6205 | What is multi-cloud? | Using services from multiple cloud providers | It reduces vendor dependency. |
| 6206 | What is cloud migration? | Moving applications and data to cloud platforms | It modernizes infrastructure. |
| 6207 | What is lift and shift migration? | Moving applications without major changes | It provides quick migration. |
| 6208 | What is cloud-native application? | Application designed specifically for cloud environments | It uses cloud capabilities. |
| 6209 | What is microservices architecture? | Architecture splitting applications into small services | It improves scalability and flexibility. |
| 6210 | What is monolithic architecture? | Architecture where all components are combined | It is simpler but less flexible. |
| 6211 | What is service-oriented architecture? | Architecture using independent services | It promotes reuse. |
| 6212 | What is SOA? | Service-Oriented Architecture abbreviation | It organizes software as services. |
| 6213 | What is microservice? | Small independently deployable application component | It performs a specific business function. |
| 6214 | What is bounded context? | Domain boundary in domain-driven design | It defines model ownership. |
| 6215 | What is Domain-Driven Design? | Software design approach focused on business domains | It aligns code with business concepts. |
| 6216 | What is DDD? | Domain-Driven Design abbreviation | It models complex business systems. |
| 6217 | What is domain model? | Representation of business concepts in software | It captures business rules. |
| 6218 | What is entity in DDD? | Object with unique identity over time | It represents domain objects. |
| 6219 | What is value object? | Object defined by its values rather than identity | It models descriptive concepts. |
| 6220 | What is aggregate? | Group of related domain objects | It maintains consistency boundaries. |
| 6221 | What is aggregate root? | Main entity controlling an aggregate | It protects invariants. |
| 6222 | What is repository pattern? | Pattern abstracting data access | It separates persistence logic. |
| 6223 | What is domain service? | Service containing domain logic not belonging to entities | It handles complex rules. |
| 6224 | What is application service? | Service coordinating application operations | It connects UI and domain layers. |
| 6225 | What is CQRS? | Command Query Responsibility Segregation pattern | It separates reads and writes. |
| 6226 | What is command? | Request to change system state | It represents an action. |
| 6227 | What is query? | Request to retrieve data | It does not modify state. |
| 6228 | What is event sourcing? | Pattern storing changes as events | It preserves history. |
| 6229 | What is domain event? | Event representing important business occurrence | It communicates domain changes. |
| 6230 | What is message broker? | System managing communication between services | It enables asynchronous messaging. |
| 6231 | What is RabbitMQ? | Message broker implementing AMQP | It handles asynchronous communication. |
| 6232 | What is Apache Kafka? | Distributed event streaming platform | It processes high-volume events. |
| 6233 | What is message queue? | Queue storing messages for processing | It decouples systems. |
| 6234 | What is publish-subscribe pattern? | Messaging pattern where publishers send events to subscribers | It supports event-driven systems. |
| 6235 | What is publisher? | Component sending messages or events | It produces information. |
| 6236 | What is subscriber? | Component receiving messages or events | It consumes information. |
| 6237 | What is event-driven architecture? | Architecture based on events and messages | It enables loose coupling. |
| 6238 | What is eventual consistency? | Model where data becomes consistent over time | It supports distributed systems. |
| 6239 | What is distributed transaction? | Transaction spanning multiple systems | It coordinates multiple resources. |
| 6240 | What is two-phase commit? | Protocol coordinating distributed transactions | It ensures consistency. |
| 6241 | What is Saga pattern? | Pattern managing distributed transactions through steps | It uses compensating actions. |
| 6242 | What is compensating transaction? | Action reversing a previous operation | It handles failures. |
| 6243 | What is idempotency? | Property where repeated operations have same effect | It improves reliability. |
| 6244 | What is idempotent API? | API producing same result for repeated requests | It prevents duplicate actions. |
| 6245 | What is distributed lock? | Lock mechanism across multiple services | It coordinates shared resources. |
| 6246 | What is service discovery? | Mechanism finding available services | It supports dynamic systems. |
| 6247 | What is API Gateway? | Entry point routing client requests to services | It centralizes API management. |
| 6248 | What is reverse proxy? | Server forwarding requests to backend services | It improves routing and security. |
| 6249 | What is load balancing? | Distributing traffic among servers | It improves availability. |
| 6250 | What is caching? | Storing frequently used data for faster access | It improves performance. |
| 6251 | What is distributed cache? | Cache shared across multiple application instances | It supports scalable applications. |
| 6252 | What is in-memory cache? | Cache storing data in application memory | It provides fast access. |
| 6253 | What is cache invalidation? | Process of removing outdated cached data | It maintains data accuracy. |
| 6254 | What is cache expiration? | Time after which cached data is removed | It controls freshness. |
| 6255 | What is cache-aside pattern? | Pattern where application manages cache manually | It provides flexible caching. |
| 6256 | What is write-through cache? | Cache updated together with database writes | It keeps data synchronized. |
| 6257 | What is write-behind cache? | Cache updated first and database later | It improves write performance. |
| 6258 | What is read-through cache? | Cache automatically loads missing data | It simplifies reads. |
| 6259 | What is Redis cache? | Distributed in-memory caching system | It provides fast data retrieval. |
| 6260 | What is response caching? | Storing HTTP responses for reuse | It improves API performance. |
| 6261 | What is output caching? | Caching generated application output | It reduces processing. |
| 6262 | What is CDN caching? | Storing content at edge locations | It reduces latency. |
| 6263 | What is latency? | Time taken for a request to complete | It measures responsiveness. |
| 6264 | What is throughput? | Amount of work processed in a period | It measures capacity. |
| 6265 | What is scalability? | Ability to handle increased workload | It supports growth. |
| 6266 | What is reliability? | Ability to operate correctly over time | It ensures consistent service. |
| 6267 | What is availability? | Percentage of time a system is operational | It measures uptime. |
| 6268 | What is durability? | Ability to preserve data without loss | It protects information. |
| 6269 | What is fault tolerance? | Ability to continue operating after failures | It improves resilience. |
| 6270 | What is resilience? | Ability to recover from failures | It maintains service continuity. |
| 6271 | What is graceful degradation? | Reducing functionality while maintaining service | It improves user experience during failures. |
| 6272 | What is retry storm? | Excessive retries causing additional failures | It can overload systems. |
| 6273 | What is timeout? | Maximum waiting period for an operation | It prevents resource blocking. |
| 6274 | What is backpressure? | Mechanism controlling excessive workload | It protects systems. |
| 6275 | What is throttling mechanism? | Technique limiting resource consumption | It prevents overload. |
| 6276 | What is health check? | Endpoint or process reporting application status | It supports monitoring. |
| 6277 | What is liveness probe? | Check confirming application is running | It detects failures. |
| 6278 | What is readiness probe? | Check confirming application can receive traffic | It controls routing. |
| 6279 | What is startup probe? | Check confirming application startup completion | It handles slow initialization. |
| 6280 | What is heartbeat? | Periodic signal showing system availability | It detects failures. |
| 6281 | What is uptime? | Time a system remains available | It measures reliability. |
| 6282 | What is SLA? | Service Level Agreement | It defines service commitments. |
| 6283 | What is SLO? | Service Level Objective | It defines reliability targets. |
| 6284 | What is SLI? | Service Level Indicator | It measures service performance. |
| 6285 | What is error budget? | Allowed amount of service failure | It balances reliability and development speed. |
| 6286 | What is Site Reliability Engineering? | Engineering approach for reliable systems | It applies software practices to operations. |
| 6287 | What is SRE? | Site Reliability Engineering abbreviation | It improves operational reliability. |
| 6288 | What is chaos engineering? | Practice intentionally testing failures | It improves resilience. |
| 6289 | What is fault injection? | Introducing failures to test systems | It validates recovery. |
| 6290 | What is performance optimization? | Improving application speed and efficiency | It enhances user experience. |
| 6291 | What is profiling? | Measuring application resource usage | It finds bottlenecks. |
| 6292 | What is memory profiling? | Analysis of memory usage | It detects memory problems. |
| 6293 | What is CPU profiling? | Analysis of processor usage | It identifies expensive operations. |
| 6294 | What is garbage collection tuning? | Optimizing automatic memory cleanup | It improves performance. |
| 6295 | What is memory leak? | Unreleased memory causing growth | It reduces application stability. |
| 6296 | What is resource leak? | Failure to release resources properly | It affects performance. |
| 6297 | What is connection pool? | Collection of reusable database connections | It improves efficiency. |
| 6298 | What is thread pool? | Collection of reusable worker threads | It manages concurrency. |
| 6299 | What is asynchronous processing? | Executing work without blocking the caller | It improves responsiveness. |
| 6300 | What is background service? | Long-running application process | It performs scheduled or continuous work. |
| 6301 | What is hosted service? | A .NET service running in the background | It performs long-running tasks. |
| 6302 | What is IHostedService? | .NET interface for background services | It manages application hosted tasks. |
| 6303 | What is BackgroundService? | Base class for implementing background workers | It simplifies hosted services. |
| 6304 | What is worker service? | .NET application template for background processing | It runs continuous workloads. |
| 6305 | What is Windows Service? | Background application running as a Windows service | It runs without user interaction. |
| 6306 | What is Linux daemon? | Background process running on Linux systems | It provides continuous services. |
| 6307 | What is scheduled task? | Task executed at a defined time | It automates operations. |
| 6308 | What is cron job? | Linux scheduler for automated tasks | It runs periodic jobs. |
| 6309 | What is Quartz.NET? | .NET job scheduling library | It manages scheduled tasks. |
| 6310 | What is Hangfire? | .NET background job processing framework | It executes background tasks. |
| 6311 | What is message-driven processing? | Processing triggered by received messages | It enables asynchronous workflows. |
| 6312 | What is consumer? | Component reading messages from a queue | It processes messages. |
| 6313 | What is producer? | Component sending messages to a queue | It creates messages. |
| 6314 | What is dead-letter queue? | Queue storing failed messages | It handles processing failures. |
| 6315 | What is poison message? | Message that repeatedly fails processing | It requires special handling. |
| 6316 | What is message acknowledgement? | Confirmation that a message was processed | It controls message delivery. |
| 6317 | What is message retry? | Attempting failed message processing again | It improves reliability. |
| 6318 | What is message ordering? | Maintaining sequence of messages | It preserves processing order. |
| 6319 | What is exactly-once processing? | Guarantee that a message is processed once | It prevents duplicates. |
| 6320 | What is at-least-once delivery? | Guarantee that messages are delivered one or more times | It favors reliability. |
| 6321 | What is at-most-once delivery? | Guarantee that messages are delivered zero or one time | It avoids duplicates. |
| 6322 | What is message serialization? | Converting messages into transferable formats | It enables communication. |
| 6323 | What is message contract? | Structure definition for messages | It defines communication format. |
| 6324 | What is schema evolution? | Managing changes to data formats over time | It maintains compatibility. |
| 6325 | What is backward-compatible change? | Change supporting older consumers | It avoids breaking clients. |
| 6326 | What is forward-compatible change? | Change allowing newer data to work with older systems | It supports evolution. |
| 6327 | What is API gateway authentication? | Authentication performed at gateway level | It protects services centrally. |
| 6328 | What is API gateway routing? | Directing requests to backend services | It manages traffic flow. |
| 6329 | What is API gateway aggregation? | Combining multiple service responses | It reduces client calls. |
| 6330 | What is YARP? | Yet Another Reverse Proxy for .NET | It builds reverse proxy solutions. |
| 6331 | What is Ocelot? | API gateway library for .NET | It supports microservices routing. |
| 6332 | What is service mesh? | Infrastructure layer managing service communication | It adds observability and security. |
| 6333 | What is Istio? | Service mesh platform | It manages microservice traffic. |
| 6334 | What is Envoy proxy? | High-performance service proxy | It handles service communication. |
| 6335 | What is sidecar proxy? | Proxy running alongside an application service | It manages network traffic. |
| 6336 | What is observability stack? | Collection of monitoring tools | It provides system visibility. |
| 6337 | What is ELK stack? | Elasticsearch, Logstash, and Kibana stack | It processes and visualizes logs. |
| 6338 | What is Elasticsearch? | Search and analytics engine | It stores and queries logs. |
| 6339 | What is Logstash? | Data processing pipeline tool | It collects and transforms logs. |
| 6340 | What is Kibana? | Visualization tool for Elasticsearch data | It displays dashboards. |
| 6341 | What is Grafana? | Monitoring visualization platform | It displays metrics dashboards. |
| 6342 | What is Prometheus? | Monitoring and alerting system | It collects metrics. |
| 6343 | What is metric scraping? | Collecting metrics from endpoints | It feeds monitoring systems. |
| 6344 | What is alert rule? | Condition triggering notifications | It detects problems. |
| 6345 | What is log aggregation? | Collecting logs from multiple systems | It simplifies analysis. |
| 6346 | What is centralized logging? | Storing logs in one location | It improves troubleshooting. |
| 6347 | What is application performance monitoring? | Monitoring application behavior and performance | It identifies issues. |
| 6348 | What is APM? | Application Performance Monitoring abbreviation | It tracks application health. |
| 6349 | What is distributed tracing system? | System tracking requests across services | It analyzes complex workflows. |
| 6350 | What is OpenTelemetry collector? | Component receiving and exporting telemetry data | It processes observability signals. |
| 6351 | What is software design principle? | Guideline for creating maintainable software | It improves code quality. |
| 6352 | What is SOLID? | Five object-oriented design principles | It improves maintainability. |
| 6353 | What is Single Responsibility Principle? | Principle that a class should have one reason to change | It reduces complexity. |
| 6354 | What is Open-Closed Principle? | Principle that software should be open for extension and closed for modification | It supports flexibility. |
| 6355 | What is Liskov Substitution Principle? | Principle that derived types must replace base types safely | It ensures correct inheritance. |
| 6356 | What is Interface Segregation Principle? | Principle that clients should not depend on unused interfaces | It reduces coupling. |
| 6357 | What is Dependency Inversion Principle? | Principle that high-level modules should depend on abstractions | It improves flexibility. |
| 6358 | What is DRY principle? | Don't Repeat Yourself design principle | It reduces duplication. |
| 6359 | What is KISS principle? | Keep It Simple, Stupid principle | It encourages simplicity. |
| 6360 | What is YAGNI principle? | You Aren't Gonna Need It principle | It avoids unnecessary features. |
| 6361 | What is separation of concerns? | Dividing software into independent responsibilities | It improves maintainability. |
| 6362 | What is coupling? | Degree of dependency between components | Lower coupling improves design. |
| 6363 | What is cohesion? | Degree to which responsibilities belong together | Higher cohesion improves clarity. |
| 6364 | What is loose coupling? | Design where components depend minimally on each other | It improves flexibility. |
| 6365 | What is tight coupling? | Design where components strongly depend on each other | It reduces flexibility. |
| 6366 | What is abstraction? | Hiding implementation details behind interfaces | It simplifies usage. |
| 6367 | What is encapsulation? | Bundling data and behavior together | It protects internal state. |
| 6368 | What is inheritance? | Mechanism for deriving classes from other classes | It enables reuse. |
| 6369 | What is polymorphism? | Ability to use different implementations through a common type | It increases flexibility. |
| 6370 | What is interface? | Contract defining required behavior | It supports abstraction. |
| 6371 | What is abstract class? | Class that cannot be instantiated directly | It provides shared behavior. |
| 6372 | What is virtual method? | Method that can be overridden | It enables polymorphism. |
| 6373 | What is override keyword? | Keyword replacing inherited behavior | It customizes implementation. |
| 6374 | What is sealed class? | Class that cannot be inherited | It restricts extension. |
| 6375 | What is static class? | Class containing only static members | It cannot be instantiated. |
| 6376 | What is constructor? | Method initializing an object | It sets initial state. |
| 6377 | What is destructor? | Method called during object cleanup | It releases resources. |
| 6378 | What is finalizer? | .NET cleanup method executed by garbage collector | It handles unmanaged resources. |
| 6379 | What is IDisposable? | Interface for releasing resources | It supports cleanup. |
| 6380 | What is using statement? | Syntax for automatic resource disposal | It calls Dispose(). |
| 6381 | What is dependency injection? | Pattern providing dependencies externally | It reduces coupling. |
| 6382 | What is service locator pattern? | Pattern retrieving dependencies from a container | It can hide dependencies. |
| 6383 | What is inversion of control? | Principle where control flow is handled by a framework | It enables DI. |
| 6384 | What is IoC container? | Tool managing object creation and dependencies | It implements dependency injection. |
| 6385 | What is constructor injection? | Injecting dependencies through constructors | It is recommended in .NET. |
| 6386 | What is property injection? | Injecting dependencies through properties | It provides optional dependencies. |
| 6387 | What is method injection? | Injecting dependencies through method parameters | It provides temporary dependencies. |
| 6388 | What is dependency lifetime? | Duration an injected service exists | It controls object reuse. |
| 6389 | What is singleton lifetime? | One instance shared throughout application | It provides global reuse. |
| 6390 | What is scoped lifetime? | One instance per request or scope | It fits web requests. |
| 6391 | What is transient lifetime? | New instance every time requested | It provides short-lived objects. |
| 6392 | What is service registration? | Adding services to dependency injection container | It enables injection. |
| 6393 | What is IServiceCollection? | .NET collection for registering services | It configures DI. |
| 6394 | What is IServiceProvider? | .NET service resolver | It creates service instances. |
| 6395 | What is middleware? | Component processing HTTP requests and responses | It forms request pipeline. |
| 6396 | What is middleware pipeline? | Ordered sequence of middleware components | It controls request handling. |
| 6397 | What is request delegate? | Function processing an HTTP request | It executes middleware logic. |
| 6398 | What is next delegate? | Reference to the next middleware | It continues pipeline execution. |
| 6399 | What is custom middleware? | User-created middleware component | It adds custom processing. |
| 6400 | What is endpoint routing? | ASP.NET Core routing system | It maps requests to handlers. |
| 6401 | What is endpoint? | A route target handling an HTTP request | It executes application logic. |
| 6402 | What is routing? | Process mapping URLs to application handlers | It directs requests. |
| 6403 | What is attribute routing? | Routing defined using attributes on controllers or actions | It provides explicit routes. |
| 6404 | What is conventional routing? | Routing based on predefined patterns | It uses common URL structures. |
| 6405 | What is route parameter? | Variable part of a URL pattern | It captures request values. |
| 6406 | What is route constraint? | Rule restricting acceptable route values | It validates routes. |
| 6407 | What is controller? | Component handling HTTP requests in MVC/API | It coordinates responses. |
| 6408 | What is controller action? | Method responding to a request | It executes endpoint logic. |
| 6409 | What is IActionResult? | Interface representing HTTP action results | It supports flexible responses. |
| 6410 | What is ActionResult<T>? | Typed controller response wrapper | It combines data and HTTP results. |
| 6411 | What is ControllerBase? | Base class for API controllers | It provides API helpers. |
| 6412 | What is Controller class? | MVC controller base class | It supports views and APIs. |
| 6413 | What is ApiController attribute? | Attribute enabling API-specific behavior | It improves API development. |
| 6414 | What is automatic model validation? | Automatic checking of request models | It reduces manual validation. |
| 6415 | What is ModelState? | Object containing model binding and validation information | It tracks validation errors. |
| 6416 | What is model binding? | Process converting HTTP data into objects | It maps request values. |
| 6417 | What is model binder? | Component performing model binding | It creates action parameters. |
| 6418 | What is custom model binder? | User-defined model binding logic | It handles special conversions. |
| 6419 | What is model validation? | Process checking object rules | It ensures valid input. |
| 6420 | What is validation attribute? | Attribute defining validation rules | It validates models. |
| 6421 | What is Required attribute? | Validation attribute requiring a value | It prevents empty input. |
| 6422 | What is StringLength attribute? | Validation attribute limiting string size | It controls text length. |
| 6423 | What is Range attribute? | Validation attribute restricting numeric values | It validates ranges. |
| 6424 | What is RegularExpression attribute? | Validation attribute matching patterns | It validates formats. |
| 6425 | What is custom validation attribute? | User-created validation rule | It handles custom logic. |
| 6426 | What is FluentValidation? | .NET validation library | It provides fluent validation rules. |
| 6427 | What is DTO? | Data Transfer Object | It transfers data between layers. |
| 6428 | What is request DTO? | Object representing incoming API data | It models client input. |
| 6429 | What is response DTO? | Object representing outgoing API data | It controls returned data. |
| 6430 | What is AutoMapper? | Object mapping library for .NET | It converts between models. |
| 6431 | What is object mapping? | Converting one object type into another | It separates models. |
| 6432 | What is projection? | Selecting required data into another shape | It improves query efficiency. |
| 6433 | What is IQueryable? | Query representation executed by provider | It enables deferred queries. |
| 6434 | What is IEnumerable? | Collection enumeration interface | It works with in-memory data. |
| 6435 | What is deferred execution? | Delaying query execution until needed | It improves flexibility. |
| 6436 | What is immediate execution? | Executing a query immediately | It retrieves results at once. |
| 6437 | What is ToList()? | LINQ method executing query into a list | It materializes results. |
| 6438 | What is First()? | LINQ method returning first matching item | It throws if none exists. |
| 6439 | What is FirstOrDefault()? | LINQ method returning first item or default | It avoids exceptions. |
| 6440 | What is Single()? | LINQ method requiring exactly one item | It validates uniqueness. |
| 6441 | What is SingleOrDefault()? | LINQ method returning one item or default | It supports optional results. |
| 6442 | What is Any()? | LINQ method checking existence | It returns a boolean. |
| 6443 | What is All()? | LINQ method checking all items | It validates conditions. |
| 6444 | What is Where()? | LINQ method filtering collections | It applies conditions. |
| 6445 | What is Select()? | LINQ method projecting values | It transforms data. |
| 6446 | What is SelectMany()? | LINQ method flattening collections | It combines sequences. |
| 6447 | What is OrderBy()? | LINQ method sorting ascending | It orders results. |
| 6448 | What is OrderByDescending()? | LINQ method sorting descending | It reverses ordering. |
| 6449 | What is GroupBy()? | LINQ method grouping elements | It creates grouped results. |
| 6450 | What is Join()? | LINQ method combining sequences | It relates data sources. |
| 6451 | What is LINQ? | Language Integrated Query | It provides querying capabilities in .NET. |
| 6452 | What is LINQ to Objects? | LINQ querying in-memory collections | It works with objects. |
| 6453 | What is LINQ to SQL? | LINQ querying SQL databases | It translates queries to SQL. |
| 6454 | What is LINQ provider? | Component translating LINQ expressions | It executes queries against data sources. |
| 6455 | What is expression tree? | Data structure representing code expressions | It enables query translation. |
| 6456 | What is lambda expression? | Anonymous function syntax in C# | It defines inline logic. |
| 6457 | What is anonymous function? | Function without a name | It is used for short operations. |
| 6458 | What is delegate? | Type-safe reference to a method | It enables callbacks. |
| 6459 | What is Func delegate? | Generic delegate returning a value | It represents functions. |
| 6460 | What is Action delegate? | Generic delegate returning no value | It represents procedures. |
| 6461 | What is Predicate delegate? | Delegate returning a boolean result | It tests conditions. |
| 6462 | What is event? | C# mechanism for notifications | It enables publisher-subscriber communication. |
| 6463 | What is event handler? | Method responding to an event | It handles notifications. |
| 6464 | What is callback? | Method passed for later execution | It enables asynchronous patterns. |
| 6465 | What is anonymous type? | Type created without explicit declaration | It groups temporary data. |
| 6466 | What is tuple? | Data structure containing multiple values | It returns multiple values. |
| 6467 | What is value tuple? | Lightweight tuple type in C# | It supports named elements. |
| 6468 | What is pattern matching? | Feature matching values against patterns | It simplifies conditions. |
| 6469 | What is switch expression? | Expression-based switch syntax | It returns values from patterns. |
| 6470 | What is nullable reference type? | C# feature tracking possible null references | It improves null safety. |
| 6471 | What is nullable value type? | Value type that can contain null | It represents optional values. |
| 6472 | What is null-coalescing operator? | Operator providing fallback values | It handles null values. |
| 6473 | What is null-conditional operator? | Operator safely accessing members on null objects | It prevents null exceptions. |
| 6474 | What is required keyword? | C# keyword requiring initialization | It enforces object setup. |
| 6475 | What is init accessor? | Property setter allowing initialization only | It supports immutable objects. |
| 6476 | What is record type? | Reference type designed for immutable data | It provides value equality. |
| 6477 | What is record struct? | Value-type record | It combines structs and records. |
| 6478 | What is with expression? | Syntax creating modified copies | It works with immutable objects. |
| 6479 | What is pattern matching with switch? | Switch using type and property patterns | It simplifies branching. |
| 6480 | What is collection expression? | C# syntax for creating collections | It simplifies initialization. |
| 6481 | What is List<T>? | Generic dynamic array collection | It stores ordered items. |
| 6482 | What is Dictionary<TKey,TValue>? | Key-value collection | It provides fast lookup. |
| 6483 | What is HashSet<T>? | Collection storing unique values | It prevents duplicates. |
| 6484 | What is Queue<T>? | FIFO collection | It processes items in order. |
| 6485 | What is Stack<T>? | LIFO collection | It processes last item first. |
| 6486 | What is LinkedList<T>? | Collection of linked nodes | It supports efficient insertions. |
| 6487 | What is ConcurrentDictionary? | Thread-safe dictionary collection | It supports parallel access. |
| 6488 | What is ConcurrentQueue? | Thread-safe queue collection | It supports concurrent processing. |
| 6489 | What is Immutable collection? | Collection that cannot be modified after creation | It improves safety. |
| 6490 | What is IEnumerable<T>? | Generic enumeration interface | It supports iteration. |
| 6491 | What is IEnumerator<T>? | Object used to iterate collections | It controls enumeration. |
| 6492 | What is yield return? | Keyword creating iterator sequences | It enables lazy iteration. |
| 6493 | What is iterator? | Method returning elements one at a time | It supports deferred processing. |
| 6494 | What is extension method? | Method adding functionality to existing types | It extends types without inheritance. |
| 6495 | What is partial class? | Class split across multiple files | It organizes large classes. |
| 6496 | What is partial method? | Method declaration and implementation split | It supports generated code. |
| 6497 | What is namespace? | Logical grouping of types | It prevents naming conflicts. |
| 6498 | What is assembly? | Compiled .NET unit containing code | It is deployment unit. |
| 6499 | What is namespace alias? | Alias for a namespace reference | It resolves naming conflicts. |
| 6500 | What is global using directive? | C# feature importing namespaces globally | It reduces repeated imports. |
| 6501 | What is .NET runtime? | Execution environment for .NET applications | It manages program execution. |
| 6502 | What is CLR? | Common Language Runtime | It executes .NET code. |
| 6503 | What is CTS? | Common Type System | It defines common data types in .NET. |
| 6504 | What is CLS? | Common Language Specification | It defines rules for .NET language interoperability. |
| 6505 | What is JIT compiler? | Just-In-Time compiler | It converts IL code into machine code. |
| 6506 | What is AOT compilation? | Ahead-of-Time compilation | It compiles code before execution. |
| 6507 | What is Native AOT? | .NET ahead-of-time native compilation | It creates native executables. |
| 6508 | What is IL? | Intermediate Language | It is CPU-independent .NET code. |
| 6509 | What is CIL? | Common Intermediate Language | It is standardized IL format. |
| 6510 | What is metadata? | Information describing assemblies and types | It enables runtime features. |
| 6511 | What is assembly manifest? | Assembly information stored in metadata | It describes assembly contents. |
| 6512 | What is managed code? | Code executed under CLR control | It receives runtime services. |
| 6513 | What is unmanaged code? | Code executed outside CLR management | It directly uses system resources. |
| 6514 | What is interop? | Communication between managed and unmanaged code | It enables integration. |
| 6515 | What is P/Invoke? | Platform Invocation Services | It calls native APIs. |
| 6516 | What is COM interop? | Communication with COM components | It integrates older components. |
| 6517 | What is garbage collector? | Automatic memory management system | It releases unused objects. |
| 6518 | What is GC generation? | Memory grouping strategy in garbage collection | It improves performance. |
| 6519 | What is Generation 0? | Youngest garbage collection generation | It contains short-lived objects. |
| 6520 | What is Generation 1? | Intermediate garbage collection generation | It stores medium-lived objects. |
| 6521 | What is Generation 2? | Long-lived object generation | It stores persistent objects. |
| 6522 | What is Large Object Heap? | Heap storing large objects | It manages large allocations. |
| 6523 | What is LOH compaction? | Process reducing LOH fragmentation | It improves memory usage. |
| 6524 | What is weak reference? | Reference that does not prevent garbage collection | It supports memory-sensitive caching. |
| 6525 | What is memory allocation? | Reserving memory for objects | It creates runtime objects. |
| 6526 | What is stack memory? | Memory area storing local variables and execution data | It supports method calls. |
| 6527 | What is heap memory? | Memory area storing reference objects | It stores dynamically allocated objects. |
| 6528 | What is boxing? | Converting value type to object type | It creates heap objects. |
| 6529 | What is unboxing? | Extracting value type from object | It retrieves boxed values. |
| 6530 | What is value type? | Type storing data directly | It is usually stored on stack. |
| 6531 | What is reference type? | Type storing reference to object data | It points to heap objects. |
| 6532 | What is struct? | Value type containing data and methods | It represents small data objects. |
| 6533 | What is class? | Reference type defining objects | It supports object-oriented programming. |
| 6534 | What is enum? | Value type representing named constants | It improves readability. |
| 6535 | What is interface default implementation? | Interface feature allowing method implementations | It supports interface evolution. |
| 6536 | What is access modifier? | Keyword controlling visibility | It defines accessibility. |
| 6537 | What is public modifier? | Access modifier allowing broad access | It exposes members. |
| 6538 | What is private modifier? | Access modifier limiting access to containing type | It hides implementation details. |
| 6539 | What is protected modifier? | Access modifier allowing derived class access | It supports inheritance. |
| 6540 | What is internal modifier? | Access modifier limiting access to assembly | It controls assembly visibility. |
| 6541 | What is protected internal modifier? | Combination allowing assembly or derived access | It broadens accessibility. |
| 6542 | What is private protected modifier? | Modifier allowing derived access within assembly | It restricts inheritance access. |
| 6543 | What is readonly field? | Field assignable only during initialization | It prevents modification. |
| 6544 | What is const? | Compile-time constant value | It cannot change. |
| 6545 | What is static member? | Member shared by all instances | It belongs to the type. |
| 6546 | What is instance member? | Member belonging to an object instance | It stores object-specific data. |
| 6547 | What is object initializer? | Syntax for initializing object properties | It simplifies creation. |
| 6548 | What is collection initializer? | Syntax for initializing collections | It simplifies setup. |
| 6549 | What is constructor chaining? | Calling one constructor from another | It reduces duplicate code. |
| 6550 | What is copy constructor? | Constructor creating object from another object | It copies object data. |
| 6551 | What is operator overloading? | Defining custom behavior for operators | It improves type usability. |
| 6552 | What is implicit conversion? | Automatic conversion between compatible types | It happens without explicit casting. |
| 6553 | What is explicit conversion? | Manual type conversion using casting | It requires developer control. |
| 6554 | What is type casting? | Converting one type into another | It changes data representation. |
| 6555 | What is as operator? | Safe reference type conversion operator | It returns null if conversion fails. |
| 6556 | What is is operator? | Type checking operator | It verifies compatibility. |
| 6557 | What is typeof operator? | Operator returning type information | It retrieves metadata. |
| 6558 | What is nameof operator? | Operator returning identifier name | It improves refactoring safety. |
| 6559 | What is sizeof operator? | Operator returning size of value types | It gets memory size. |
| 6560 | What is checked context? | Context detecting arithmetic overflow | It improves safety. |
| 6561 | What is unchecked context? | Context ignoring arithmetic overflow | It allows overflow behavior. |
| 6562 | What is exception filter? | Condition controlling catch execution | It handles exceptions selectively. |
| 6563 | What is throw expression? | Throw used as an expression | It supports concise error handling. |
| 6564 | What is stack trace? | Record of method calls during execution | It helps debugging. |
| 6565 | What is inner exception? | Original exception causing another exception | It preserves error details. |
| 6566 | What is aggregate exception? | Exception containing multiple exceptions | It handles parallel failures. |
| 6567 | What is Task? | Object representing asynchronous operation | It manages async workflows. |
| 6568 | What is Task<T>? | Task returning a result value | It represents async results. |
| 6569 | What is async keyword? | Keyword enabling asynchronous methods | It simplifies async programming. |
| 6570 | What is await keyword? | Keyword waiting for asynchronous completion | It avoids blocking threads. |
| 6571 | What is async state machine? | Compiler-generated structure managing async execution | It controls async flow. |
| 6572 | What is synchronization context? | Context controlling continuation execution | It manages async callbacks. |
| 6573 | What is ConfigureAwait()? | Method controlling continuation behavior | It improves async performance. |
| 6574 | What is Task.Run()? | Method running work on thread pool | It executes background tasks. |
| 6575 | What is Task.WhenAll()? | Method waiting for multiple tasks | It runs tasks concurrently. |
| 6576 | What is Task.WhenAny()? | Method completing when one task finishes | It handles first completion. |
| 6577 | What is ValueTask? | Lightweight alternative to Task | It reduces allocations. |
| 6578 | What is cancellation token? | Object signaling operation cancellation | It supports cooperative cancellation. |
| 6579 | What is CancellationTokenSource? | Object creating cancellation tokens | It triggers cancellation. |
| 6580 | What is parallel programming? | Executing multiple operations simultaneously | It improves performance. |
| 6581 | What is Parallel.For()? | Parallel loop execution method | It processes iterations concurrently. |
| 6582 | What is Parallel.ForEach()? | Parallel collection processing method | It runs iterations concurrently. |
| 6583 | What is PLINQ? | Parallel LINQ | It executes LINQ queries in parallel. |
| 6584 | What is thread? | Independent execution path | It performs concurrent work. |
| 6585 | What is process? | Running instance of an application | It owns resources. |
| 6586 | What is application domain? | Isolation boundary for .NET applications | It separates execution contexts. |
| 6587 | What is thread synchronization? | Controlling access between threads | It prevents race conditions. |
| 6588 | What is lock statement? | C# synchronization mechanism | It protects shared resources. |
| 6589 | What is Monitor? | .NET synchronization primitive | It manages locks. |
| 6590 | What is Mutex? | Synchronization object across processes | It provides exclusive access. |
| 6591 | What is Semaphore? | Synchronization object limiting access count | It controls concurrency. |
| 6592 | What is SemaphoreSlim? | Lightweight semaphore implementation | It supports async scenarios. |
| 6593 | What is ReaderWriterLockSlim? | Lock allowing multiple readers | It improves read concurrency. |
| 6594 | What is race condition? | Error caused by uncontrolled concurrent access | It creates unpredictable results. |
| 6595 | What is deadlock in threading? | Situation where threads wait indefinitely | It stops execution. |
| 6596 | What is thread safety? | Ability to operate correctly with multiple threads | It prevents concurrency bugs. |
| 6597 | What is immutable object? | Object whose state cannot change after creation | It improves thread safety. |
| 6598 | What is concurrent collection? | Thread-safe collection type | It supports parallel access. |
| 6599 | What is producer-consumer pattern? | Pattern separating data production and consumption | It manages concurrent workflows. |
| 6600 | What is Channel<T>? | .NET asynchronous producer-consumer data structure | It enables communication between tasks. |
| 6601 | What is reflection? | Ability to inspect and interact with types at runtime | It enables dynamic behavior. |
| 6602 | What is System.Reflection namespace? | .NET namespace providing reflection APIs | It accesses metadata. |
| 6603 | What is Type class? | Class representing type information | It describes runtime types. |
| 6604 | What is Assembly.Load()? | Method loading assemblies dynamically | It enables runtime loading. |
| 6605 | What is Activator class? | Class creating objects dynamically | It supports runtime instantiation. |
| 6606 | What is dynamic keyword? | C# keyword bypassing compile-time type checking | It enables dynamic binding. |
| 6607 | What is dynamic binding? | Resolving members at runtime | It supports flexible object access. |
| 6608 | What is late binding? | Resolving method calls during runtime | It delays type resolution. |
| 6609 | What is early binding? | Resolving method calls during compilation | It improves performance and safety. |
| 6610 | What is attribute? | Metadata attached to program elements | It provides additional information. |
| 6611 | What is custom attribute? | User-defined metadata class | It adds custom annotations. |
| 6612 | What is AttributeUsage? | Attribute controlling attribute behavior | It defines attribute targets. |
| 6613 | What is compiler directive? | Instruction processed by compiler | It changes compilation behavior. |
| 6614 | What is preprocessor directive? | Directive beginning with # | It controls source processing. |
| 6615 | What is conditional compilation? | Compiling code based on conditions | It supports multiple builds. |
| 6616 | What is DEBUG symbol? | Compilation symbol for debug builds | It enables debugging code. |
| 6617 | What is RELEASE symbol? | Compilation symbol for release builds | It enables optimized builds. |
| 6618 | What is source generator? | Compiler feature generating source code automatically | It reduces manual coding. |
| 6619 | What is Roslyn? | .NET compiler platform | It provides compiler APIs. |
| 6620 | What is analyzer? | Tool analyzing code during compilation | It detects issues. |
| 6621 | What is code fix provider? | Tool suggesting automated code corrections | It improves productivity. |
| 6622 | What is nullable analysis? | Compiler analysis for null references | It prevents null errors. |
| 6623 | What is compiler warning? | Message about possible code problems | It improves quality. |
| 6624 | What is compiler error? | Error preventing successful compilation | It blocks build. |
| 6625 | What is build configuration? | Set of compiler and project settings | It controls builds. |
| 6626 | What is MSBuild? | .NET build automation system | It compiles projects. |
| 6627 | What is project file? | File describing project configuration | It defines build settings. |
| 6628 | What is SDK-style project? | Modern .NET project format | It simplifies configuration. |
| 6629 | What is csproj file? | C# project configuration file | It defines project metadata. |
| 6630 | What is solution file? | File grouping multiple projects | It manages related projects. |
| 6631 | What is NuGet.config? | NuGet configuration file | It manages package sources. |
| 6632 | What is global.json? | File controlling .NET SDK version | It manages SDK selection. |
| 6633 | What is Directory.Build.props? | Shared MSBuild property file | It centralizes project settings. |
| 6634 | What is Directory.Build.targets? | Shared MSBuild target file | It extends build processes. |
| 6635 | What is target framework? | Framework version a project runs on | It defines compatibility. |
| 6636 | What is TFM? | Target Framework Moniker | It identifies framework versions. |
| 6637 | What is .NET Standard? | Specification of common .NET APIs | It enables library sharing. |
| 6638 | What is .NET Framework? | Original Windows-focused .NET platform | It supports legacy applications. |
| 6639 | What is .NET Core? | Cross-platform .NET implementation | It evolved into modern .NET. |
| 6640 | What is modern .NET? | Unified cross-platform .NET platform | It runs on multiple operating systems. |
| 6641 | What is runtime identifier? | Identifier specifying operating system and architecture | It controls deployment targets. |
| 6642 | What is RID? | Runtime Identifier abbreviation | It identifies runtime environments. |
| 6643 | What is self-contained deployment? | Deployment including required runtime | It runs without installed .NET. |
| 6644 | What is framework-dependent deployment? | Deployment requiring installed runtime | It reduces package size. |
| 6645 | What is single-file deployment? | Publishing application as one file | It simplifies distribution. |
| 6646 | What is trimming? | Removing unused code during publishing | It reduces application size. |
| 6647 | What is globalization? | Supporting different languages and cultures | It enables worldwide applications. |
| 6648 | What is localization? | Adapting application for specific cultures | It supports regional users. |
| 6649 | What is resource file? | File storing localized content | It supports translations. |
| 6650 | What is CultureInfo? | .NET class representing culture information | It handles regional formatting. |
| 6651 | What is globalization in .NET? | Support for different cultures and languages | It enables international applications. |
| 6652 | What is localization in ASP.NET Core? | Adapting application content for specific cultures | It provides translated resources. |
| 6653 | What is IStringLocalizer? | .NET service for localized strings | It retrieves culture-specific text. |
| 6654 | What is ResourceManager? | .NET class managing resource files | It loads localized resources. |
| 6655 | What is culture fallback? | Using a parent culture when a specific resource is unavailable | It improves localization support. |
| 6656 | What is date formatting? | Converting dates into culture-specific formats | It improves user experience. |
| 6657 | What is number formatting? | Formatting numeric values based on culture | It supports regional conventions. |
| 6658 | What is time zone? | Region-based offset from UTC | It handles global time differences. |
| 6659 | What is UTC? | Coordinated Universal Time | It provides global time reference. |
| 6660 | What is DateTime? | .NET structure representing date and time | It stores temporal values. |
| 6661 | What is DateTimeOffset? | Date and time with offset information | It preserves time zone context. |
| 6662 | What is TimeSpan? | Structure representing duration | It measures time intervals. |
| 6663 | What is DateOnly? | .NET type representing date without time | It handles date values. |
| 6664 | What is TimeOnly? | .NET type representing time without date | It handles time values. |
| 6665 | What is UTC conversion? | Converting local time into universal time | It avoids time ambiguity. |
| 6666 | What is serialization versioning? | Managing changes in serialized data formats | It maintains compatibility. |
| 6667 | What is binary serialization? | Converting objects into binary format | It stores object data. |
| 6668 | What is JSON serialization? | Converting objects into JSON | It supports API communication. |
| 6669 | What is XML serialization? | Converting objects into XML | It supports XML-based systems. |
| 6670 | What is serialization attribute? | Attribute controlling serialization behavior | It customizes data output. |
| 6671 | What is JsonIgnore attribute? | Attribute excluding properties from JSON output | It hides data. |
| 6672 | What is JsonPropertyName attribute? | Attribute changing JSON property names | It controls JSON mapping. |
| 6673 | What is JsonConverter? | Custom JSON conversion component | It handles special types. |
| 6674 | What is custom JSON converter? | User-defined JSON serialization logic | It controls complex conversion. |
| 6675 | What is polymorphic serialization? | Serialization supporting derived types | It preserves object hierarchy. |
| 6676 | What is API payload? | Data sent in an API request or response | It contains information. |
| 6677 | What is request body? | Data sent with an HTTP request | It provides input. |
| 6678 | What is response body? | Data returned in an HTTP response | It provides output. |
| 6679 | What is HTTP header? | Metadata sent with HTTP messages | It provides request information. |
| 6680 | What is custom HTTP header? | User-defined HTTP metadata | It carries additional information. |
| 6681 | What is ETag? | HTTP entity tag identifying resource versions | It supports caching. |
| 6682 | What is conditional request? | Request depending on resource state | It improves efficiency. |
| 6683 | What is If-None-Match header? | Header using ETag validation | It supports cache checks. |
| 6684 | What is optimistic concurrency? | Concurrency approach using version checks | It prevents lost updates. |
| 6685 | What is pessimistic concurrency? | Concurrency approach locking resources | It prevents simultaneous changes. |
| 6686 | What is concurrency token? | Value used to detect data changes | It supports conflict handling. |
| 6687 | What is row version? | Database value tracking record changes | It supports concurrency control. |
| 6688 | What is timestamp column? | Database column storing version information | It detects modifications. |
| 6689 | What is transaction? | Group of operations executed as one unit | It maintains consistency. |
| 6690 | What is ACID? | Atomicity, Consistency, Isolation, Durability properties | It defines transaction reliability. |
| 6691 | What is atomicity? | Transaction completes fully or not at all | It prevents partial updates. |
| 6692 | What is consistency? | Transaction keeps data valid | It maintains rules. |
| 6693 | What is isolation? | Transactions operate independently | It prevents interference. |
| 6694 | What is durability? | Completed transactions survive failures | It preserves data. |
| 6695 | What is database transaction scope? | Boundary defining transactional operations | It controls commits and rollbacks. |
| 6696 | What is commit? | Saving transaction changes permanently | It completes a transaction. |
| 6697 | What is rollback? | Undoing transaction changes | It restores previous state. |
| 6698 | What is savepoint? | Intermediate transaction checkpoint | It allows partial rollback. |
| 6699 | What is isolation level? | Rule controlling transaction visibility | It manages concurrency. |
| 6700 | What is dirty read? | Reading uncommitted data | It can cause inconsistent results. |
| 6701 | What is non-repeatable read? | Reading different values for the same row during a transaction | It occurs due to concurrent updates. |
| 6702 | What is phantom read? | Seeing new rows during repeated queries | It occurs due to inserts or deletes. |
| 6703 | What is read uncommitted isolation? | Isolation level allowing dirty reads | It provides lowest consistency. |
| 6704 | What is read committed isolation? | Isolation level allowing only committed data reads | It prevents dirty reads. |
| 6705 | What is repeatable read isolation? | Isolation level preventing changed reads | It maintains read consistency. |
| 6706 | What is snapshot isolation? | Isolation level using row versions | It reduces locking. |
| 6707 | What is serializable isolation? | Highest isolation level | It provides strongest consistency. |
| 6708 | What is database deadlock? | Situation where transactions wait on each other | It blocks execution. |
| 6709 | What is deadlock detection? | Process identifying database deadlocks | It enables recovery. |
| 6710 | What is query optimization? | Improving query execution efficiency | It increases performance. |
| 6711 | What is execution plan? | Strategy chosen by database engine for query execution | It explains performance. |
| 6712 | What is query optimizer? | Database component selecting execution plans | It improves queries. |
| 6713 | What is database index? | Data structure improving query speed | It accelerates searches. |
| 6714 | What is clustered index? | Index determining physical row order | It organizes table storage. |
| 6715 | What is non-clustered index? | Separate structure pointing to table data | It speeds lookups. |
| 6716 | What is composite index? | Index containing multiple columns | It supports multi-column queries. |
| 6717 | What is covering index? | Index containing all required query data | It avoids table lookups. |
| 6718 | What is index fragmentation? | Disorder in index storage | It reduces performance. |
| 6719 | What is index rebuild? | Recreating an index | It improves organization. |
| 6720 | What is index reorganize? | Defragmenting an index | It improves efficiency. |
| 6721 | What is primary key? | Column uniquely identifying rows | It enforces uniqueness. |
| 6722 | What is foreign key? | Column referencing another table | It maintains relationships. |
| 6723 | What is unique key? | Constraint allowing unique values | It prevents duplicates. |
| 6724 | What is candidate key? | Column that can uniquely identify records | It can become a primary key. |
| 6725 | What is composite key? | Key made from multiple columns | It identifies combined uniqueness. |
| 6726 | What is surrogate key? | Artificial key generated for records | It simplifies identification. |
| 6727 | What is natural key? | Key based on real-world data | It represents business identity. |
| 6728 | What is database normalization? | Process reducing data duplication | It improves data design. |
| 6729 | What is first normal form? | Normalization requiring atomic values | It removes repeating groups. |
| 6730 | What is second normal form? | Normalization removing partial dependencies | It improves structure. |
| 6731 | What is third normal form? | Normalization removing transitive dependencies | It reduces redundancy. |
| 6732 | What is denormalization? | Adding redundancy for performance | It improves read speed. |
| 6733 | What is database schema? | Structure defining database objects | It organizes data. |
| 6734 | What is table? | Database object storing records | It stores structured data. |
| 6735 | What is column? | Field representing an attribute | It defines data type. |
| 6736 | What is row? | Record containing related values | It represents an entity instance. |
| 6737 | What is view? | Virtual table based on a query | It simplifies data access. |
| 6738 | What is stored procedure? | Precompiled database operation | It executes server-side logic. |
| 6739 | What is function in SQL? | Database routine returning values | It performs calculations. |
| 6740 | What is trigger? | Automatic database action on events | It responds to changes. |
| 6741 | What is database constraint? | Rule enforcing data integrity | It maintains correctness. |
| 6742 | What is check constraint? | Rule restricting column values | It validates data. |
| 6743 | What is default constraint? | Rule assigning default values | It provides automatic values. |
| 6744 | What is cascade delete? | Automatic deletion of related records | It maintains relationships. |
| 6745 | What is cascade update? | Automatic update of related keys | It maintains consistency. |
| 6746 | What is SQL injection? | Attack inserting malicious SQL commands | It compromises databases. |
| 6747 | What is parameterized query? | Query using parameters instead of string concatenation | It prevents SQL injection. |
| 6748 | What is prepared statement? | Precompiled parameterized SQL command | It improves security and performance. |
| 6749 | What is ORM? | Object Relational Mapping | It maps objects to database tables. |
| 6750 | What is Entity Framework Core? | ORM framework for .NET | It simplifies database access. |
